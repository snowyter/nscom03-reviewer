   ...
   "body": [
    ...
    },
    {
     ...
     "head": [
      "Working group",
      "Scope",
      "Familiar brand or name"
     ],
     "rows": [
      [
       "802.1",
       "Bridging, VLANs and higher-layer LAN protocols",
       "Spanning tree, VLAN tagging"
      ],
      [
       "802.3",
       "Carrier-sense multiple access with collision detection over wired media",
       "Ethernet"
      ],
      [
       "802.11",
      ...
      [
       "802.16",
       "Broadband wireless access over metropolitan distances",
       "WiMAX"
      ],
      [
       "802.18/802.19",
       "Regulatory and coexistence advisory",
   ...
   "body": [
    ...
    },
    {
     ...
     "rows": [
      [
       "Station",
       "Addressable device with a MAC address and a radio",
       "Not necessarily a user device; an AP is a station too"
      ],
      [
       "Basic service set",
       "One cell: stations sharing a coverage area",
       "Cannot reach other cells without an AP and a DS"
      ],
      [
       "Access point",
       "A station that relays between the wireless cell and the DS",
       "Not a router; it bridges at the link layer"
      ],
      [
       "Distribution system",
       "Backbone joining access points",
       "Technology is unspecified; usually a wired LAN"
      ],
      [
       "Extended service set",
       "Two or more BSSs joined by a DS",
       "Not a single radio cell; stations roam between BSSs"
      ]
     ]
    },
    {
   ...
   "body": [
    ...
    },
    {
     ...
     "rows": [
      [
       "No transition",
       "Stationary, or within one BSS",
       "Nothing beyond ordinary access-point service",
       "Fixed desktop, laptop in one room"
      ],
      [
       "BSS transition",
       "Between BSSs inside one ESS",
       "Hand over between access points on the same DS",
       "Walking down a floor of one building"
      ],
      [
       "ESS transition",
       "Between one ESS and another",
       "Re-home the station; link handover alone is not enough",
       "Moving between two separate campuses"
      ]
     ]
    },
    {
    ...
    },
    {
     ...
     "rows": [
      ...
      [
       "802.11 FHSS",
       "2.4 GHz ISM",
       "Hop across 79 x 1 MHz subbands",
    ...
    },
    {
     ...
     "rows": [
      [
       ...
       "FSK, PSK, baseband",
       "1-2 Mbps",
       "79 x 1 MHz channels for FHSS"
      ],
      [
       "802.11a",
       "5 GHz",
       "OFDM, 48 data + 4 control subcarriers",
       "PSK (18 Mbps), QAM (54 Mbps)",
       "54 Mbps",
   ...
   "body": [
    ...
    },
    {
     ...
     "rows": [
      [
       "DCF",
       "Every station, no controller",
       "Yes, stations compete",
       "Mandatory distributed medium access"
      ],
      [
       "PCF",
       "Access point polls stations",
       "No, contention-free period",
       "Optional bounded-delay service"
      ],
      [
       "CSMA/CD",
       "Ethernet stations",
       "Yes, with detection",
       "Not usable over radio; needs simultaneous send and receive"
      ],
      [
       "CSMA/CA",
       "802.11 stations",
       "Yes, with avoidance",
       "Carrier sense plus acknowledgement and optional RTS/CTS"
      ]
     ]
    },
    {
   ...
   "body": [
    ...
    },
    {
     ...
     "rows": [
      [
       "Hidden station",
       "Two senders cannot hear each other but both reach the receiver",
       "Simultaneous transmissions collide at the receiver; senders never detect it",
       "RTS/CTS handshake plus NAV"
      ],
      [
       "Exposed station",
       "Two senders hear each other but their receivers are in different directions",
       "One station defers unnecessarily; throughput is wasted",
       "Mitigated by short control frames and by the NAV covering only the real reservation"
      ],
      [
       "Collision detection",
       "Cannot be done reliably over half-duplex radio",
       "No immediate retransmission trigger",
       "Positive acknowledgement of every data frame"
      ]
     ]
    },
    {
   ...
   "body": [
    ...
    },
    {
     ...
     "rows": [
      ...
      [
       "Type",
       "The type of information: management 00, control 01, or data 10."
      ],
      [
       "Subtype",
       "Defines the subtype within each type, for example RTS, CTS or ACK within the control type."
      ],
      [
       "To DS",
       "Set when the frame is destined for the distribution system; explained with the addressing cases."
      ],
      [
       "From DS",
       "Set when the frame has come from the distribution system; explained with the addressing cases."
      ],
      [
       "More flag",
       "When set to 1, more fragments of this frame follow."
      ],
      [
       "Retry",
       "When set to 1, this frame is a retransmission of an earlier frame."
      ],
      [
       "Pwr mgt",
       "When set to 1, the station is in power management mode."
      ],
      [
       "More data",
       "When set to 1, the station has more data waiting to send."
      ],
      [
       "WEP",
       "Wired equivalent privacy; when set to 1, encryption has been applied to the frame."
      ],
      [
       "Rsvd",
       "Reserved for future use and ignored by current implementations."
      ]
     ]
    },
    {
    ...
    },
    {
     ...
     "rows": [
      [
       ...
       "Two or more piconets sharing stations"
      ],
      [
       "Master count",
       "Exactly one",
       "One per constituent piconet"
      ],
      [
       "Active stations",
       "Up to eight including the master",
       "Grows with the number of piconets"
      ],
      [
       "Parked stations",
       "Up to eight additional slaves",
       "Per piconet, as above"
      ],
      [
       "Who owns timing",
       "The master owns the clock and the hop sequence",
       "Each master owns its own; shared stations switch between them"
      ]
     ]
    },
    {
    ...
    },
    {
     ...
     "rows": [
      [
       ...
       "Avoiding latency",
       "Never retransmitted",
       "Voice and other real-time streams"
      ],
      [
       "ACL",
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     ...
     "head": [
      "Concern",
      "Shared wireless LAN (802.11)",
      "Point-to-point wide-area link"
     ],
     "rows": [
      [
       "Who may transmit",
       "Contested; CSMA/CA, backoff and RTS/CTS",
       "Only two devices exist, so no contention"
      ],
      [
       "Frame delimiting",
       "Frame control field and duration field",
       "Flag sequence at each end of the frame"
      ],
      [
       "Transparency",
       "Subtype and address fields give meaning to each header",
       "Bit stuffing so the flag cannot occur in the data"
      ],
      [
       "Corruption",
       "Positive acknowledgement, retry bit, retransmission",
       "Frame check sequence plus sequence numbers and retransmission"
      ],
      [
       "Flow control",
       "Implicit, through the acknowledgement and window behaviour",
       "Explicit sliding window of outstanding frames"
      ]
     ]
    },
    {
 ...
 "flashcards": [
  {
   ...
   "a": "802.11 defines wireless LANs, marketed as Wi-Fi; 802.16 defines broadband wireless access, marketed as WiMAX.",
   "sec": "s1"
  },
  {
   "q": "What are the four topics the module's introduction lists for the wireless LAN?",
   "a": "Architecture, physical layer, MAC layer, and the addressing mechanism.",
   "sec": "s2"
  },
  {
   "q": "What is a basic service set, and what changes when it contains an access point?",
   "a": "A BSS is a cell of stationary or mobile wireless stations. With an access point it can relay traffic outside the cell; without one it is stand-alone and cannot send data to other BSSs.",
   "sec": "s3"
  },
  {
   "q": "What is an extended service set?",
   "a": "Two or more basic service sets with access points, connected through a distribution system, which is usually a wired LAN.",
   "sec": "s3"
  },
  {
   "q": "Distinguish no-transition, BSS-transition and ESS-transition mobility.",
   "a": "No transition: stationary or moving only inside one BSS. BSS transition: moving between BSSs within one ESS. ESS transition: moving from one ESS to another.",
   "sec": "s4"
  },
  {
   "q": "How does FHSS make interception and interference harder?",
   "a": "The carrier dwells briefly on one frequency, hops to another for the same time, and repeats the cycle, so a listener must know the pseudo-random hopping sequence to follow it and a narrowband interferer spoils only the hops landing on it.",
   "sec": "s5"
  },
  {
   "q": "Give the FHSS numbers: band, subbands, modulation and data rates.",
   "a": "2.4 GHz ISM band (about 2.4 to 2.4835 GHz), 79 subbands of 1 MHz each, FSK modulation with two or four levels giving 1 or 2 Mbps.",
   "sec": "s5"
  },
  {
   "q": "What does DSSS do to each data bit, and what modulation does it use?",
   "a": "It replaces each bit with a chip code, spreading the signal over a wider band; it uses PSK, either BPSK or QPSK, in the 2.4 GHz band.",
   "sec": "s5"
  },
  {
   "q": "Why does the slide note call multipath fading the main issue for FHSS, and how does hopping help?",
   "a": "Reflected copies arrive at different times and add constructively or destructively. Because the copies land on different frequencies, a deep fade on one subband costs only the frames sent during that hop.",
   "sec": "s6"
  },
  {
   "q": "What are the limits of the 802.11 infrared physical layer?",
   "a": "1 or 2 Mbps, a range of 10 to 20 metres, cannot penetrate walls, and does not work outdoors.",
   "sec": "s6"
  },
  {
   "q": "How many subcarriers does 802.11a use, and how are they divided?",
   "a": "52 subcarriers: 48 carry data and 4 carry control information such as pilots.",
   "sec": "s7"
  },
  {
   "q": "What modulation reaches 18 Mbps and what reaches 54 Mbps in 802.11a?",
   "a": "PSK gives 18 Mbps and QAM gives 54 Mbps in the 5 GHz OFDM scheme.",
   "sec": "s7"
  },
  {
   "q": "What is CCK and which amendment uses it?",
   "a": "Complementary code keying, used by 802.11b HR-DSSS, encodes 4 or 8 bits into one CCK symbol and gives the rates 1, 2, 5.5 and 11 Mbps.",
   "sec": "s7"
  },
  {
   "q": "Which two 802.11 amendments are incompatible, and which one is backward compatible with 802.11b?",
   "a": "802.11b (2.4 GHz) and 802.11a (5 GHz) are incompatible. 802.11g is backward compatible with 802.11b.",
   "sec": "s7"
  },
  {
   "q": "Name the two coordination functions of the 802.11 MAC and say which is mandatory.",
   "a": "The distributed coordination function (DCF), which is mandatory and contention-based, and the point coordination function (PCF), which is optional and contention-free.",
   "sec": "s8"
  },
  {
   "q": "Give the three reasons the slides give for why WANs cannot implement CSMA/CD.",
   "a": "Collision detection requires sending and receiving at the same time, which is costly; a collision may not be detected because of a hidden terminal; and distance can cause fading that prevents a station hearing a collision.",
   "sec": "s8"
  },
  {
   "q": "What is the hidden station problem?",
   "a": "Two stations that cannot hear each other both sense the medium as idle and transmit to the same receiver, so their frames collide at the receiver while neither sender can detect the collision.",
   "sec": "s9"
  },
  {
   "q": "What is the exposed station problem?",
   "a": "A station defers because it hears a neighbour transmitting, even though its own receiver lies in another direction and its transmission would not have collided.",
   "sec": "s9"
  },
  {
   "q": "How does the RTS/CTS handshake solve the hidden station problem?",
   "a": "The CTS is heard by stations in range of the receiver, including the hidden station, and both frames carry a duration that listeners record in their NAV as a promise to stay off the medium.",
   "sec": "s9"
  },
  {
   "q": "How do SIFS and DIFS differ, and why does the ordering matter?",
   "a": "SIFS is the shortest interframe space, granted to a station continuing an existing exchange; DIFS is the longer gap a station observes before starting a new contention. Because SIFS is shorter, a station mid-exchange keeps the medium.",
   "sec": "s10"
  },
  {
   "q": "Where in a CSMA/CA exchange can a collision occur, according to the slide note?",
   "a": "Only during the handshake period, the RTS and CTS exchange, because afterwards every station in range has heard the duration and set its NAV.",
   "sec": "s10"
  },
  {
   "q": "What is the network allocation vector?",
   "a": "A local countdown each station keeps from the duration field of an overheard RTS or CTS, acting as virtual carrier sense so the station treats the medium as busy until it expires.",
   "sec": "s10"
  },
  {
   "q": "What are the type values for management, control and data frames in the 802.11 FC field?",
   "a": "Management is 00, control is 01, and data is 10; the current version subfield value is 0.",
   "sec": "s11"
  },
  {
   "q": "Give the control-frame subtype values for RTS, CTS and ACK.",
   "a": "Request to send is 1011, clear to send is 1100, and acknowledgement is 1101, all under control type 01.",
   "sec": "s11"
  },
  {
   "q": "What does the retry subfield in the FC field mean, and why does it exist?",
   "a": "When set to 1 the frame is a retransmission. It lets a receiver recognise a duplicate by its sequence number rather than treating the copy as new data.",
   "sec": "s11"
  },
  {
   "q": "In addressing case 1, what do the To DS and From DS bits say and what are the addresses?",
   "a": "To DS = 0 and From DS = 0: the frame goes from one station in a BSS to another in the same BSS, with destination in address 1, source in address 2 and the BSS ID in address 3; the ACK goes to the original sender.",
   "sec": "s12"
  },
  {
   "q": "In addressing case 3, what does address 3 contain?",
   "a": "To DS = 1 and From DS = 0, a station sending to an access point; address 3 contains the final destination of the frame, and the ACK goes back to the original station.",
   "sec": "s12"
  },
  {
   "q": "When are all four address fields of an 802.11 header used?",
   "a": "In case 4, To DS = 1 and From DS = 1, when the distribution system is itself wireless and a frame travels from one access point to another.",
   "sec": "s12"
  },
  {
   "q": "How many stations can a piconet hold, and what is a parked slave?",
   "a": "Up to eight stations with one master, plus up to eight additional slaves in parked state, which are synchronised but cannot communicate.",
   "sec": "s13"
  },
  {
   "q": "What makes a scatternet, and can one station belong to two piconets?",
   "a": "A scatternet is combined piconets; a slave in one piconet can be a master in another, so stations are shared between the overlapping cells.",
   "sec": "s13"
  },
  {
   "q": "What band, spreading and modulation does the Bluetooth radio layer use?",
   "a": "The 2.4 GHz ISM band, frequency-hopping spread spectrum, and GFSK, a version of FSK with Gaussian bandwidth filtering.",
   "sec": "s14"
  },
  {
   "q": "How does TDD-TDMA slot assignment work in single-slave and multiple-slave communication?",
   "a": "The master uses even-numbered slots. In single-slave mode the slave uses odd-numbered slots; in multiple-slave mode a slave sends in the next odd slot only if the previous slot was addressed to it.",
   "sec": "s14"
  },
  {
   "q": "How long is a Bluetooth slot, and how many slots can a frame occupy?",
   "a": "A slot is 625 microseconds and a frame can occupy one, three or five slots.",
   "sec": "s14"
  },
  {
   "q": "Contrast SCO and ACL links.",
   "a": "SCO is synchronous connection oriented: latency matters more than integrity, so a damaged packet is never retransmitted. ACL is asynchronous connectionless: integrity matters more than latency, so a damaged packet is retransmitted.",
   "sec": "s15"
  },
  {
   "q": "What are L2CAP's four duties?",
   "a": "Multiplexing, segmentation and reassembly, quality of service, and group management, used for data exchange on an ACL link.",
   "sec": "s15"
  },
  {
   "q": "What do the length and channel identifier fields in an L2CAP packet accomplish?",
   "a": "The length field tells the receiver how many payload bytes follow, enabling reassembly; the channel identifier names the logical channel, enabling multiplexing.",
   "sec": "s15"
  },
  {
   "q": "Why does a wide-area point-to-point link need no medium-access arbitration?",
   "a": "Exactly two devices share the link, so there is no contention; the link layer's complexity goes into framing, transparency, error detection and recovery instead.",
   "sec": "s16"
  }
 ],
 "quiz": [
  {
   ...
   "answer": 2,
   "why": "The slides name Wi-Fi as 802.11 and WiMAX as 802.16; 802.3 is Ethernet and 802.1 covers bridging and VLANs.",
   "sec": "s1"
  },
  {
   ...
   "choices": [
    ...
    "stand-alone, unable to send data to other BSSs",
    "a distribution system",
    "a scatternet"
   ],
   "answer": 1,
   "why": "The slides state that a BSS without an AP is stand-alone and cannot send data to other BSSs; only an AP plus a distribution system joins cells.",
   "sec": "s3"
  },
  {
   ...
   "answer": 1,
   "why": "BSS-transition mobility is movement from one BSS to another confined to a single ESS; ESS-transition mobility would require crossing into a different ESS.",
   "sec": "s4"
  },
  {
   "q": "The FHSS physical layer in the slides uses the 2.4 GHz ISM band divided into how many subbands?",
   "choices": [
    "13 subbands of 5 MHz",
    "48 subbands of 1 MHz",
    "52 subbands of 1 MHz",
    "79 subbands of 1 MHz"
   ],
   "answer": 3,
   "why": "The slides give 79 subbands of 1 MHz each in the low end of the 2.4 GHz ISM band, with FSK giving 1 or 2 Mbps.",
   "sec": "s5"
  },
  {
   "q": "Which statement about 802.11a is correct?",
   "choices": [
    "It uses the 2.4 GHz band and is backward compatible with 802.11b",
    "It uses the 5 GHz band with OFDM and 48 data subcarriers",
    "It uses HR-DSSS with CCK in the 5 GHz band",
    "It is an infrared physical layer"
   ],
   "answer": 1,
   "why": "802.11a uses OFDM in the 5 GHz ISM band with 48 data subcarriers and 4 control subcarriers, reaching 54 Mbps with QAM.",
   "sec": "s7"
  },
  {
   ...
   "answer": 1,
   "why": "The slides state 802.11g uses OFDM in the 2.4 GHz band at 54 Mbps and is backward compatible with 802.11b, while 802.11a and 802.11b are incompatible.",
   "sec": "s7"
  },
  {
   "q": "Which of these is NOT one of the three reasons the slides give for why a WAN cannot implement CSMA/CD?",
   "choices": [
    "Collision detection requires sending and receiving at the same time",
    "A hidden terminal may prevent a station from detecting a collision",
    "Distance can cause fading that hides a collision",
    "The medium is too fast for carrier sensing"
   ],
   "answer": 3,
   "why": "The slides cite half-duplex send and receive cost, the hidden terminal, and distance fading. Medium speed is not among the three stated reasons.",
   "sec": "s8"
  },
  {
   "q": "In the hidden station problem, why does the collision go undetected by the senders?",
   "choices": [
    "The frames are too short to overlap",
    "Each sender is out of range of the other, so neither hears the collision at the receiver",
    "The access point discards the frames before collision",
    "The NAV suppresses detection"
   ],
   "answer": 1,
   "why": "The two senders cannot hear each other, so each senses the medium as idle and transmits; the signals collide at the receiver, invisible to both senders.",
   "sec": "s9"
  },
  {
   "q": "According to the slide note, during which part of a CSMA/CA exchange can a collision occur?",
   "choices": [
    "Only during the handshake period of RTS and CTS",
    "Throughout the data transmission",
    "Only during the acknowledgement",
    "Never, because CSMA/CA eliminates collisions"
   ],
   "answer": 0,
   "why": "The slide note says collision only occurs during the handshake period, because after the RTS/CTS exchange every station in range has the duration and sets its NAV.",
   "sec": "s10"
  },
  {
   ...
   "answer": 2,
   "why": "The slides define Pwr mgt as set to 1 when the station is in power management mode; Retry marks a retransmission and WEP marks encryption.",
   "sec": "s11"
  },
  {
   ...
   "answer": 1,
   "why": "The slides give RTS as 1011, CTS as 1100 and ACK as 1101, all under the control type value 01.",
   "sec": "s11"
  },
  {
   ...
   "answer": 2,
   "why": "In case 2 the frame comes from the distribution system to a station, so address 1 is the destination station, address 2 is the sending AP and address 3 is the original source.",
   "sec": "s12"
  },
  {
   "q": "How many address fields are used when To DS = 1 and From DS = 1, and why?",
   "choices": [
    "Two, because the DS is wireless so only the endpoints matter",
    "Three, because the BSS ID replaces the fourth",
    "All four, because the distribution system is itself wireless",
    "None, because the frame is broadcast"
   ],
   "answer": 2,
   "why": "Case 4 applies when the distribution system is wireless, so both the intermediate transmitter and receiver must be named alongside the final destination and original source.",
   "sec": "s12"
  },
  {
   "q": "In a piconet, how many stations can be active and how many additional slaves may be parked?",
   "choices": [
    "Eight active, no parked slaves",
    "Seven active plus eight parked",
    "Eight active including the master, plus up to eight parked",
    "Sixteen active slaves"
   ],
   "answer": 2,
   "why": "The slides say up to eight stations of which one is the master, plus up to eight additional slaves in parked state that are synchronised but cannot communicate.",
   "sec": "s13"
  },
  {
   "q": "In Bluetooth multiple-slave communication, when may a slave transmit?",
   "choices": [
    "In any odd-numbered slot it chooses",
    "In the next odd-numbered slot only if the previous slot was addressed to it",
    "Only in even-numbered slots",
    "Whenever the master is silent"
   ],
   "answer": 1,
   "why": "The master uses even slots; a slave sends in the next odd slot only if the packet in the previous slot was addressed to it, which prevents slave collisions.",
   "sec": "s14"
  },
  {
   "q": "Which Bluetooth link type retransmits a damaged packet?",
   "choices": [
    "SCO, because latency matters more than integrity",
    "ACL, because data integrity matters more than latency",
    "Both SCO and ACL",
    "Neither, since the baseband suppresses retransmission"
   ],
   "answer": 1,
   "why": "ACL is the asynchronous connectionless link, where integrity outranks latency so damaged packets are retransmitted; SCO never retransmits a damaged packet.",
   "sec": "s15"
  },
  {
   ...
   "choices": [
    ...
    "Multiplexing, segmentation and reassembly, QoS, and group management",
    "Frequency hopping, slot timing and power control",
    "Routing, addressing and fragmentation at layer 3"
   ],
   "answer": 1,
   "why": "L2CAP is used for data exchange on an ACL link and its listed duties are multiplexing, segmentation and reassembly, quality of service and group management.",
   "sec": "s15"
  },
  {
   "q": "Why does a point-to-point wide-area data link not need medium-access arbitration?",
   "choices": [
    "Because it uses CSMA/CA with a very long DIFS",
    "Because only two devices share the link, so there is no contention",
    "Because the flag sequence prevents collisions",
    "Because acknowledgements are never used"
   ],
   "answer": 1,
   "why": "With exactly two devices on the link there is no contention to arbitrate; the link layer's work is framing, transparency, error detection and recovery instead.",
   "sec": "s16"
  }
 ]
});
