...
window.NSCOM_MODULES.push({
  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: protocol data units and encapsulation",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: which layers are what",
        },
        {
          type: "list",
          items: [
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why the collapsing is not merely cosmetic",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: what 'error-free between two end nodes' actually means",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: what the slides leave unstated",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why the deterministic-versus-contention distinction matters",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: where the metropolitan area network fits",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why topologies are studied at the data link layer, not the physical layer",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: how the 802 standards are structured",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: the numbering convention for 802.3 physical layers",
        },
        {
          type: "list",
          items: [
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: the propagation-delay argument for low orbit",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: the cell concept and frequency reuse",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: why wireless medium access is harder than wired",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: the four characteristics of a physical-layer specification",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: guided and unguided media",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why the three analog parameters matter",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: the decisive difference between analog and digital",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why limited bandwidth blocks a digital baseband signal",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: modulation also buys spectrum sharing",
        },
        {
          type: "p",
  ...
  flashcards: [
    { q: "What is a protocol data unit, and name the PDU at each OSI layer?", a: "A PDU is the unit of data a layer produces after adding its own control header. Message/data at layers 7-5, segment at layer 4, packet or datagram at layer 3, frame at layer 2, and just bits at layer 1 — which has no PDU of its own.", sec: "s1" },
    { q: "Name the seven OSI layers from top to bottom.", a: "Application, presentation, session, transport, network, data link and physical. Layers 1-3 are network support layers, layer 4 is the transport layer, and layers 5-7 are user support layers.", sec: "s2" },
    { q: "What address is used at each of OSI layers 2, 3 and 4?", a: "Layer 2 uses the physical or MAC address, layer 3 uses the logical (IP) address, and layer 4 uses the port number that identifies a process.", sec: "s2" },
    { q: "How does the Internet (TCP/IP) model map onto OSI?", a: "Its application layer covers OSI's application, presentation and session layers; its transport layer is OSI's transport layer; its internet layer is OSI's network layer; and its link (network access) layer covers both OSI's data link and physical layers.", sec: "s3" },
    { q: "Why does the Internet model have no presentation or session layer?", a: "Because it was built from practice rather than from an architecture: any encoding or dialog management an application needs is built into that application's own protocol, so no separate layers were defined for those jobs.", sec: "s3" },
    { q: "State the slide definition of the data link layer's purpose.", a: "To regulate and format transmission of data from software on a node to the network cabling facilities — creating the network environment for the wire, dictating data formats, timing and bit sequencing for each particular type of network, and enabling data frames to be transmitted error-free between two end nodes over the physical layer.", sec: "s4" },
    { q: "Does the data link layer's reliability extend end to end?", a: "No. Its reliability is local — node to node, one hop at a time. Each hop in a multi-router path has its own link-layer conversation. End-to-end reliability across the whole path is the transport layer's job.", sec: "s4" },
    { q: "List the six services the data link layer provides to upper layers.", a: "Provisioning links between network entities (usually adjacent nodes within a subnetwork); framing; frame sequencing; flow control; error detection with notification, and sometimes correction; and selection of QoS parameters including sufficient bandwidth and predictable, guaranteed delays.", sec: "s5" },
    { q: "What does the slide say about error correction at the data link layer?", a: "Detection and notification are what the layer provides — it detects errors in the physical layer and notifies when they are found. Correction is not guaranteed: the layer can also sometimes correct errors, but that is optional.", sec: "s5" },
    { q: "What is frame sequencing and why is it needed?", a: "It means maintaining the correct ordering of frames as they are exchanged. It is needed because a retransmitted frame can arrive out of order, so the receiver needs sequence information to reorder frames or detect a missing one.", sec: "s5" },
    { q: "Into which two sublayers is the data link layer divided, and what does each do?", a: "The logical link control (LLC) sublayer on top handles framing, flow control, sequencing and error control. The media access control (MAC) sublayer below handles addressing and the rules for sharing the physical medium.", sec: "s6" },
    { q: "What does media access control do, and name the two style families.", a: "It establishes coordination between nodes so that a node can gain access to the media and transmit data. The slides name two families: ALOHA style, which is contention based, and token style, which is deterministic and ordered.", sec: "s6" },
    { q: "Name the three types of networks the slides list at the data link layer, with their spans.", a: "Local area network — computers typically within 5 km. Wide area network — geographically long-distance connections. Wireless network — unguided media, which can be either short or long distance.", sec: "s7" },
    { q: "What is a metropolitan area network and why is it a separate category?", a: "A MAN is a high-speed network spanning a city or large campus, typically owned by a single operator and used to link many LANs. It is separate because it occupies a span where propagation delay becomes comparable to frame transmission time, so the LAN's design assumptions break down, yet it is not a long-haul carrier network.", sec: "s7" },
    { q: "Describe a bus, a star and a ring topology.", a: "A bus has one shared backbone that every station taps and hears. A star connects every station to a central device over a dedicated link. A ring connects each station to exactly two neighbours in a closed loop, with frames travelling in one direction.", sec: "s8" },
    { q: "Why is topology a data link layer topic rather than a physical layer topic?", a: "Because the topology determines the access method, and the access method is a MAC sublayer concern. A bus forces contention rules because every station hears every frame; a ring enables ordered token passing; a star with a central switch removes contention altogether.", sec: "s8" },
    { q: "Why did IEEE take over LAN standardisation?", a: "Because in the early days of networking there were no standards: organisations used proprietary networks and were locked into a vendor or technology. IEEE assumed responsibility for setting LAN standards, primarily for the physical and data link layers, using the OSI reference model as a framework.", sec: "s9" },
    { q: "What is IEEE 802.3, and what access method does it use?", a: "IEEE 802.3 is Ethernet — the dominant wired LAN standard. It uses CSMA/CD, a contention-based (ALOHA style) medium access method. Its physical-layer variants are named in the form rate-BASE-medium, such as 1000BASE-T.", sec: "s9" },
    { q: "Which IEEE 802 standards use token access, and what are they called?", a: "IEEE 802.4 is Token Bus (token passing over a bus physical topology) and IEEE 802.5 is Token Ring (token passing over a ring). Both are deterministic, guaranteeing each station a bounded turn.", sec: "s9" },
    { q: "Decode the name 1000BASE-T.", a: "1000 means 1000 Mbps, BASE means baseband transmission (the digital signal is placed on the medium directly), and T means twisted-pair cable. So it is 1 Gbps baseband signalling over twisted pair.", sec: "s9" },
    { q: "What is dark fibre?", a: "Unused fibre optic cable — fibre that has been laid but is not lit with active transmission equipment, and which can therefore be leased for another party to activate itself.", sec: "s10" },
    { q: "How high are Starlink satellites, and why does that altitude matter?", a: "Starlink deploys at 550 km above Earth. The low altitude keeps propagation delay small — roughly 1.83 ms one way and 3.67 ms round trip — compared with about 119 ms one way for a geostationary satellite at 35,786 km, so the link is usable for interactive traffic.", sec: "s10" },
    { q: "Compute the one-way propagation delay to a geostationary satellite at 35,786 km, with c = 3 × 10⁸ m/s.", a: "t = d/c = 35,786,000 / (3 × 10⁸) = 0.11929 s ≈ 119.3 ms one way, giving about 238.6 ms round trip — which is why geostationary links suit broadcast but not voice.", sec: "s10" },
    { q: "What is a cell in a wireless network?", a: "A coverage area served by one base station or access point. A wide-area wireless network divides its territory into cells and reuses the same frequencies in cells far enough apart not to interfere, which is how a fixed slice of spectrum serves a whole city.", sec: "s11" },
    { q: "Give the three wireless network examples from the slides and their scale.", a: "Bluetooth — a personal area network over about 10 m. IEEE 802.11 series wireless network (Wi-Fi) — a local area network. LTE mobile phone network — a wide-area cellular network.", sec: "s11" },
    { q: "What does the physical layer do with the frames it receives from layer 2?", a: "It translates frames received from the data link layer into electrical, optical, or electromagnetic signals representing 0 and 1 values, or bits. Its specification includes the cable and connector types, the electrical signals on each pin, and how bit values become physical signals.", sec: "s12" },
    { q: "Name the four characteristics of a physical-layer specification.", a: "Mechanical (connector shape, pin layout, cable dimensions), electrical (voltage levels, data rate and distance limits), functional (what each pin or circuit does) and procedural (the sequence of events for a transfer).", sec: "s12" },
    { q: "What is the difference between guided and unguided media?", a: "Guided media provide a physical path the signal follows — twisted pair, coaxial cable, optical fibre. Unguided media carry the signal through free space with no physical path — radio, microwave and infrared.", sec: "s12" },
    { q: "Define analog and digital communication as the slides state them.", a: "Analog communication is any method based on analog principles where a signal can continuously vary in strength or quantity, for example voltage in a circuit; data are represented by varying voltage, frequency or phase. Digital communication is any method where a signal is coded in binary form to represent 1 or 0 — for example +5 V for binary 1 and 0 V for binary 0.", sec: "s13" },
    { q: "In how many ways can data be represented on an analog wave?", a: "Three, matching the three parameters of a sine wave: by varying the voltage (amplitude), by varying the frequency, or by varying the phase of the wave.", sec: "s13" },
    { q: "Why does a digital signal survive noise better than an analog one?", a: "A digital signal carries its information in which of a small number of discrete levels the value is nearest, so the receiver only has to decide between a few states and small noise does not change the answer. Analog information sits in the exact value of a continuously varying quantity, so added noise is permanent and cannot be removed by amplifying the signal.", sec: "s13" },
    { q: "Why is analog transmission needed when bandwidth is limited?", a: "Limited bandwidth in a medium does not allow a digital signal to pass through — a bandpass channel does not pass the low-frequency content a baseband digital waveform needs to hold its shape. So the digital signal is modulated into an analog signal and then transmitted over the medium.", sec: "s14" },
    { q: "What equipment appears at each end of a link that uses analog transmission for digital data?", a: "A modulator at the sending end and a demodulator at the receiving end, repeated at both ends for a bidirectional link. The pair is called a modem — modulator and demodulator in one unit.", sec: "s14" },
    { q: "Besides passing a bandpass channel, what second benefit does modulation give?", a: "Spectrum sharing. Modulating each user's data onto a different carrier lets many independent channels travel over the same cable or the same radio spectrum without interfering, which is frequency-division multiplexing — the basis of cable TV, cellular channels and Wi-Fi channels.", sec: "s14" },
    { q: "Which layer-2 environments does a frame cross between a laptop and a router, and what changes?", a: "It crosses an 802.11 wireless LAN and then an 802.3 Ethernet segment. The frame format, MAC addresses, maximum frame size and access rules all change at the access point, while the IP packet inside is untouched because addressing at layer 3 is an end-to-end concern.", sec: "s15" },
  ],
  quiz: [
    {
      ...
      answer: 2,
      why: "Each layer names its protocol data unit. The data link layer produces a frame, the network layer produces a packet, the transport layer produces a segment, and the physical layer deals only in bits.",
      sec: "s1",
    },
    {
      ...
      answer: 1,
      why: "In the Internet model the link (network access) layer covers both OSI's data link layer and OSI's physical layer, which is why TCP/IP is described with fewer layers than OSI's seven.",
      sec: "s3",
    },
    {
      ...
      answer: 0,
      why: "OSI's application, presentation and session layers all become the Internet model's application layer. Transport and network remain as separate layers, and the link layer absorbs OSI layers 1 and 2.",
      sec: "s3",
    },
    {
      q: "According to the slides, what is the purpose of the data link layer?",
      choices: [
        "To route packets between independent networks using logical addresses",
        "To regulate and format transmission of data from software on a node to the network cabling facilities",
        "To provide end-to-end process-to-process delivery with retransmission",
        "To convert bits into electrical, optical or electromagnetic signals",
      ],
      answer: 1,
      why: "The slide states the purpose as regulating and formatting transmission of data from software on a node to the network cabling facilities, creating the network environment for the wire and dictating formats, timing and bit sequencing. Signal conversion is the physical layer's job.",
      sec: "s4",
    },
    {
      ...
      choices: [
        ...
        "Two end nodes, over the physical layer",
        "Two applications on separate continents",
        "Two subnets using different routing protocols",
      ],
      answer: 1,
      why: "The slide wording is that it enables data frames to be transmitted error-free between two end nodes over the physical layer. Its scope is node to node, which means local, per-hop reliability rather than end-to-end process delivery.",
      sec: "s4",
    },
    {
      q: "Which of these is NOT one of the services the slides list the data link layer as providing to upper layers?",
      choices: [
        "Framing — partitioning data into frames with recognized boundaries",
        "Frame sequencing — maintaining the correct ordering of frames",
        "Flow control as frames are exchanged across a link",
        "Routing frames between autonomous systems using logical addresses",
      ],
      answer: 3,
      why: "Routing between autonomous systems is a network-layer function. The slide list covers link provisioning, framing, frame sequencing, flow control, error detection with notification (and sometimes correction), and QoS parameter selection.",
      sec: "s5",
    },
    {
      q: "What does the slides' wording say about error handling at the data link layer?",
      choices: [
        "It always corrects every error it detects",
        "It detects errors and notifies, and can sometimes correct them",
        "It detects errors but never notifies the sender",
        "It performs no error handling at all; that is layer 4's job",
      ],
      answer: 1,
      why: "The slide says the layer detects errors in the physical layer, including error notification when errors are detected but not corrected, and that it can also sometimes correct errors. Correction is optional, detection and notification are not.",
      sec: "s5",
    },
    {
      q: "Frame sequencing at the data link layer involves:",
      choices: [
        "Converting bits into electrical or optical signals in the correct order",
        "Maintaining the correct ordering of frames as they are exchanged",
        "Assigning QoS parameters to each frame",
        "Encrypting frames so their contents cannot be reordered",
      ],
      answer: 1,
      why: "The slide defines frame sequencing as maintaining the correct ordering of frames as they are being exchanged across the link. Retransmission is what makes the ordering question real, since a retried frame can arrive after a later one.",
      sec: "s5",
    },
    {
      ...
      answer: 1,
      why: "The data link layer divides into logical link control (LLC) above, which handles framing, flow control, sequencing and error control, and media access control (MAC) below, which handles addressing and shared-medium access rules.",
      sec: "s6",
    },
    {
      q: "What does media access control do?",
      choices: [
        "Establishes coordination between nodes so that a node can gain access to the media and transmit data",
        "Converts frames into electromagnetic signals for the medium",
        "Selects the best route for a frame across the internetwork",
        "Compresses frame payloads before transmission",
      ],
      answer: 0,
      why: "The slide defines media access control as establishing coordination between nodes in the network so that a node can gain access to the media and transmit data. The slides name ALOHA style and token style as the two families of techniques.",
      sec: "s6",
    },
    {
      q: "Which pair correctly names the two families of media access control techniques given in the slides?",
      choices: [
        "ALOHA style and token style",
        "Synchronous and asynchronous",
        "Baseband and broadband",
        "Analog and digital",
      ],
      answer: 0,
      why: "The slide lists ALOHA style and token style. ALOHA style is contention based, so frames can collide and must be retried; token style is ordered and deterministic because only the token holder may transmit.",
      sec: "s6",
    },
    {
      ...
      answer: 1,
      why: "The slides describe a LAN as a connection of computers typically within 5 km, with the computers normally adjacent to one another and interconnected using copper or fibre media. MAN and WAN spans are larger.",
      sec: "s7",
    },
    {
      ...
      choices: [
        ...
        "A star-wired Ethernet LAN",
        "Bluetooth piconet",
        "IEEE 802.3 CSMA/CD segment",
      ],
      answer: 0,
      why: "The slides name submarine cable and fibre cables laid beside roads or railway as WAN examples, along with satellite and terrestrial microwave links. Ethernet, Bluetooth and CSMA/CD are LAN or PAN technologies.",
      sec: "s10",
    },
    {
      q: "What does the term dark fibre mean?",
      choices: [
        "Fibre optic cable that has been physically damaged",
        "Unused fibre optic cable that has been laid but is not lit",
        "Fibre optic cable carrying encrypted traffic",
        "Fibre optic cable reserved for emergency services",
      ],
      answer: 1,
      why: "The slides define dark fibre as unused fibre optic cable — cable that is in place but carries no light and therefore no traffic, and which can be leased and activated by another party.",
      sec: "s10",
    },
    {
      ...
      answer: 1,
      why: "The slide states a global deployment of satellites at 550 km above Earth, aimed at delivering high speed broadband internet where access has been unreliable, expensive or unavailable. The 35,786 km figure is geostationary altitude, not Starlink's.",
      sec: "s10",
    },
    {
      ...
      choices: [
        "Bluetooth",
        "IEEE 802.11 series wireless network",
        "LTE mobile phone network",
        "IEEE 802.5 token ring network",
      ],
      answer: 3,
      why: "The slide names Bluetooth, the IEEE 802.11 series wireless network and the LTE mobile phone network. IEEE 802.5 is Token Ring, a wired LAN standard, not a wireless one.",
      sec: "s11",
    },
    {
      q: "What does a wireless network use a 'cell' for?",
      choices: [
        "To interconnect mobile devices within a coverage area served by a base station",
        "To store frames that failed their error check",
        "To convert analog signals back into digital form",
        "To assign MAC addresses to new stations",
      ],
      answer: 0,
      why: "The slide states that a wireless network uses a 'cell' to interconnect mobile devices. A cell is the coverage area served by one base station or access point, and frequency reuse across cells is what lets a fixed spectrum serve a whole city.",
      sec: "s11",
    },
    {
      q: "What does the physical layer do with frames received from the data link layer?",
      choices: [
        "Routes them toward the destination network",
        "Translates them into electrical, optical or electromagnetic signals representing 0 and 1 values",
        "Numbers them so they can be reordered at the receiver",
        "Encrypts them using a session key",
      ],
      answer: 1,
      why: "The slide defines the physical layer's job as translating frames received from the data link layer (layer 2) into electrical, optical, or electromagnetic signals representing 0 and 1 values, or bits.",
      sec: "s12",
    },
    {
      q: "Which of these is included in a physical-layer specification according to the slides?",
      choices: [
        "Frame boundaries and sequence numbers",
        "The type of cable and connectors used, the electrical signals on each pin, and how bit values become physical signals",
        "Port numbers and transport protocol selection",
        "Logical addresses and route metrics",
      ],
      answer: 1,
      why: "The slide's specification list is the type of cable and connectors used, the electrical signals associated with each pin and connector, and the manner in which bit values are converted into physical signals. The other options are layer 2, 3 and 4 concerns.",
      sec: "s12",
    },
    {
      q: "According to the slides, how may data be represented in analog form?",
      choices: [
        "Only by varying the voltage of the wave",
        "By varying the voltage, by varying the frequency, or by varying the phase of a wave",
        "Only by varying the frequency of the wave",
        "By varying the number of bits carried per symbol",
      ],
      answer: 1,
      why: "The slide states that data are represented in analog form by varying the voltage of the wave, by varying the frequency, or by varying the phase of a wave. Those three correspond to the three parameters of a sine wave.",
      sec: "s13",
    },
    {
      q: "In the slides' digital example, how are binary 1 and binary 0 represented?",
      choices: [
        "Binary 1 as +5 V and binary 0 as 0 V",
        "Binary 1 as 0 V and binary 0 as +5 V",
        "Binary 1 as +12 V and binary 0 as −12 V",
        "Binary 1 as a 1 kHz tone and binary 0 as a 2 kHz tone",
      ],
      answer: 0,
      why: "The slide's example is that a binary 1 can be represented as +5 V and a binary 0 can be represented as 0 V. Tone representation belongs to modulation schemes rather than to this baseband example.",
      sec: "s13",
    },
    {
      q: "Why is analog transmission needed according to the slides?",
      choices: [
        "Because analog transmission is always faster than digital transmission",
        "Because analog transmission is needed when bandwidth is limited, and limited bandwidth does not allow a digital signal to pass through",
        "Because digital signals cannot represent binary data reliably in any medium",
        "Because analog transmission requires no modulator or demodulator",
      ],
      answer: 1,
      why: "The slide states plainly that analog transmission is needed when bandwidth is limited, that limited bandwidth in a medium does not allow a digital signal to pass through, and that digital signals are therefore modulated into analog signals before transmission.",
      sec: "s14",
    },
    {
      q: "In the slide's analog transmission diagram, what appears at the sending and receiving ends respectively?",
      choices: [
        "A demodulator at the sending end and a modulator at the receiving end",
        "A modulator at the sending end and a demodulator at the receiving end",
        "A multiplexer at both ends",
        "An amplifier at both ends",
      ],
      answer: 1,
      why: "The diagram shows a modulator on the sending side and a demodulator on the receiving side, with modulators and demodulators again at the far end for the return direction. That modulator-demodulator pair is what a modem is.",
      sec: "s14",
    },
    {
      q: "Which statement about the IEEE 802 project is correct?",
      choices: [
        "IEEE assumed responsibility for LAN standards, primarily for the physical and data link layers, using the OSI reference model as a framework",
        "IEEE standardised the transport and network layers before working on LANs",
        "IEEE 802 replaced the OSI reference model entirely",
        "IEEE 802 standards cover only wireless technologies",
      ],
      answer: 0,
      why: "The slide states that in the early days of networking there were no standards and organisations were locked into vendors, so IEEE assumed responsibility for setting LAN standards, primarily for the physical and data link layers, using the OSI reference model as a framework.",
      sec: "s9",
    },
    {
      ...
      choices: [
        "802.3, using CSMA/CD",
        "802.4, using token passing",
        "802.5, using token passing",
        "802.11, using CSMA/CA",
      ],
      answer: 0,
      why: "802.3 is Ethernet and uses CSMA/CD, a contention-based ALOHA-style access method. 802.4 is Token Bus and 802.5 is Token Ring, both token based; 802.11 is wireless LAN.",
      sec: "s9",
    },
    {
      ...
      answer: 2,
      why: "This is a metropolitan area network: city-scale span, typically owned by a single operator and used to connect multiple LANs. It is larger than a LAN and smaller than a long-haul carrier WAN.",
      sec: "s7",
    },
    {
      ...
      answer: 1,
      why: "In a star topology every station connects to a central device over its own dedicated link, so one cable fault isolates a single station. On a bus all stations share one backbone; on a ring each station connects to two neighbours.",
      sec: "s8",
    },
    {
      q: "A channel passes only 300 Hz to 3300 Hz. Why can an ordinary baseband digital signal not be sent down it?",
      choices: [
        "Because the channel's bandwidth is too high for digital signals",
        "Because the channel does not pass the low-frequency content a baseband digital signal needs to hold its shape",
        "Because baseband signals can only travel over fibre",
        "Because the channel is unguided rather than guided",
      ],
      answer: 1,
      why: "The channel is bandpass and does not extend down to 0 Hz, so the low-frequency content of a baseband digital waveform is cut off and the signal arrives too deformed to decode. Modulating it onto a carrier inside the passband solves this.",
      sec: "s14",
    },
    {
      ...
      answer: 2,
      why: "With L levels, each level carries log2 L bits. Here L = 2, so log2 2 = 1 bit per level — the ordinary binary signalling case. Four levels would carry 2 bits each, but the scheme described uses only two.",
      sec: "s13",
    },
    {
      ...
      choices: [
        "The MAC addresses in the frame",
        "The frame format and maximum frame size",
        "The IP packet carried inside the frame",
        "The medium access rules in use",
      ],
      answer: 2,
      why: "The frame format, MAC addresses, maximum frame size and access rules all change at each link-layer boundary, because those are per-hop concerns. The IP packet inside is untouched, since layer-3 addressing is an end-to-end concern.",
      sec: "s15",
    },
  ],
});
