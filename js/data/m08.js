...
window.NSCOM_MODULES.push({
  ...
  sections: [
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Project 802** began in 1985 to let equipment from different vendors interoperate.",
            "Before it, proprietary networks locked customers to one manufacturer.",
            "The 802 standards cover the **physical and data link layers** — precisely what this module is about.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "why standards matter",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Ethernet** was developed in the 1970s by **Metcalfe and Boggs**, built on a shared broadcast medium.",
            "Original design goals: simple, cheap, and **decentralised** — no central controller.",
            "That decentralisation is why it uses **CSMA/CD** rather than a token or a master.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "Metcalfe's design goals",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "The frame format is fixed by **802.3**, so any two NICs agree on every field boundary.",
            "Order: **Preamble → SFD → Destination → Source → Type/Length → Data → CRC**.",
            "The **preamble** lets the receiver synchronise; the **CRC** catches corruption.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "every frame field",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Minimum 64 bytes**: guarantees the sender is still transmitting if a collision returns.",
            "**Maximum 1518 bytes**: prevents one station hogging the medium with a giant frame.",
            "Both limits exist for **different** historical reasons — know which is which.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "both length limits",
          body: [
            {
              type: "p",
      ...
      body: [
        {
          type: "list",
          items: [
            "Every NIC has a **48-bit MAC address**, burned in at manufacture.",
            "Written as six hex pairs, e.g. **00:1A:2B:3C:4D:5E**. It is a **physical** address, not a logical one.",
            "Three transmission modes: **unicast** (one), **multicast** (a group), **broadcast** (everyone).",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "reading a MAC address",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "Ethernet uses **CSMA/CD in 1-persistent mode**, with **Manchester encoding** at the physical layer.",
            "**1-persistent** = the instant the channel goes idle, transmit with probability 1.",
            "Still listen after sending — if what you hear differs from what you sent, that is a collision.",
          ],
        },
        {
          type: "deep",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "Standard Ethernet is the original **10 Mbps** family; the name encodes the properties.",
            "**10Base5** thick coax, 500 m. **10Base2** thin coax, 185 m. **10BaseT** twisted pair + hub, 100 m.",
            "**10BaseF** is fibre. Decode the name: rate, then signalling, then medium.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "decoding the names",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "A **bridge** splits one large **collision domain** into several smaller ones, based on destination MAC.",
            "A **switch is a multi-port bridge** — one collision domain per port.",
            "Smaller collision domains mean fewer collisions and more usable bandwidth.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "bridges vs switches",
          body: [
            {
              type: "p",
      ...
      body: [
        {
          type: "list",
          items: [
            "**Half-duplex**: one direction at a time, shared medium, **CSMA/CD required**.",
            "**Full-duplex**: both directions at once, dedicated point-to-point link, **no collisions, CSMA/CD disabled**.",
            "Full-duplex needs a **switch**, not a hub, because the paths must be physically separate.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "when CSMA/CD turns off",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Fast Ethernet = 100 Mbps** — ten times standard Ethernet.",
            "Frame format is **unchanged**, so it interoperates with older equipment at the frame level.",
            "Uses a hub or switch in a star topology with twisted pair at the centre.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "what stayed the same",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Gigabit Ethernet = 1000 Mbps**, with two modes.",
            "**Full-duplex** uses a switch and **drops CSMA/CD entirely**.",
            "**Half-duplex** still uses CSMA/CD. Same tenfold pattern as before.",
          ],
        },
        {
          type: "deep",
      ...
      body: [
        {
          type: "list",
          items: [
            "**10 Gigabit Ethernet = 10,000 Mbps** — and the original constraints are now gone.",
            "**Full-duplex only**: CSMA/CD is not used at all.",
            "Designed for **point-to-point fibre**, with copper variants only for short runs.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "what changed for good",
          body: [
            {
              type: "p",
      ...
      body: [
        {
          type: "list",
          items: [
            "**ARP** maps a known **IP** address to an unknown **MAC** address on the same LAN.",
            `The sender **broadcasts** "who has this IP?"; every station hears it.`,
            "Only the owner replies, **unicasting** its MAC back. The result is cached for later use.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "a full ARP exchange",
          body: [
            {
              type: "p",
      ...
      body: [
        {
          type: "list",
          items: [
            "**Transparent bridging** connects LAN segments into one logical LAN, invisibly to the stations.",
            "**Learning**: record each frame's source MAC against the port it arrived on.",
            "**Forwarding**: send only out the matching port. **Flooding**: unknown destination → every port except the source.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "the forwarding table",
          body: [
            {
              type: "p",
  ...
  flashcards: [
    { q: "When did Project 802 start, and who started it?",
      a: "Project 802 started in 1985 and was started by the IEEE Computer Society, to set standards that would enable intercommunication among equipment from a variety of manufacturers.", sec: "s1" },
    { q: "Does Project 802 replace any part of the OSI model or the TCP/IP suite?",
      a: "No. Project 802 does not seek to replace any part of the OSI model or the TCP/IP protocol suite; its goal is to specify the functions of the physical layer and the data-link layer of major LAN protocols.", sec: "s1" },
    { q: "What does Logical Link Control define, and what does Media Access Control define?",
      a: "LLC is the part of 802 that defines flow control, error control and framing, and it provides a single link-layer control protocol for all IEEE LANs. MAC is the sublayer that defines the specific access method for each LAN.", sec: "s1" },
    { q: "Who developed Ethernet, and what was the original data rate?",
      a: "The Ethernet LAN was developed in the 1970s by Robert Metcalfe and David Boggs. The original Ethernet technology has a data rate of 10 Mbps.", sec: "s2" },
    { q: "What does it mean that Ethernet offers connectionless and unreliable service?",
      a: "A frame sent is independent of the previous or next frame, so there is no connection establishment or termination phase. The sender can overwhelm the receiver and cause dropped frames, and corrupted frames are dropped silently.", sec: "s2" },
    { q: "Name the seven fields of an Ethernet frame in order.",
      a: "Preamble, Start of Frame Delimiter, Destination Address, Source Address, Type, Data and CRC. The preamble and SFD handle synchronisation and frame start; the CRC is a CRC-32.", sec: "s3" },
    { q: "What is the purpose of the preamble and of the start-of-frame delimiter?",
      a: "The preamble allows synchronisation for the receiver, and the start-of-frame delimiter signals the beginning of the frame.", sec: "s3" },
    { q: "What are the minimum and maximum sizes of the Ethernet data field, and why?",
      a: "The data field is a minimum of 46 bytes and a maximum of 1500 bytes. The minimum keeps the frame at 64 bytes so CSMA/CD can detect collisions; the maximum prevents one station from monopolising the medium.", sec: "s4" },
    { q: "Why does Ethernet have a minimum frame-length restriction?",
      a: "The minimum length restriction is required for the correct operation of CSMA/CD: the frame must take long enough to transmit that a collision anywhere in the domain can be detected before the sender finishes.", sec: "s4" },
    { q: "How long is an Ethernet address and how is it written?",
      a: "The address is 48 bits, burned into the NIC, and written in hexadecimal notation — six bytes, or twelve hex digits, such as 07:01:02:01:2C:4B.", sec: "s5" },
    { q: "What is the Ethernet broadcast address, and what do non-receiving stations do?",
      a: "The broadcast address is all 1s, FF:FF:FF:FF:FF:FF. All transmission is broadcast on the medium, but a non-receiving station ignores data not intended for itself.", sec: "s5" },
    { q: "Which access method does Ethernet use, and with which persistence?",
      a: "Ethernet uses CSMA/CD — Carrier Sense Multiple Access with Collision Detection — with the 1-persistent method, and at the physical layer it uses Manchester encoding.", sec: "s6" },
    { q: "What are the four standard Ethernet implementations, and what do their names encode?",
      a: "10Base5, 10Base2, 10BaseT and 10BaseF. The 10 is the 10 Mbps data rate, Base means baseband, and the tail gives the medium and approximate segment length: 500 m coax, 185 m thin coax, twisted pair and fibre.", sec: "s7" },
    { q: "What were the two aims of bridged and switched Ethernet?",
      a: "Switched Ethernet started with bridged Ethernet and aimed to raise the bandwidth and separate collision domains; a bridge forwards a frame to another collision domain based on MAC address, and a switch provides one collision domain per port.", sec: "s8" },
    { q: "What is the difference between half-duplex and full-duplex Ethernet?",
      a: "Half duplex allows one direction at a time over a shared medium and requires CSMA/CD. Full duplex uses a switch with separate transmit and receive paths, so both directions run at once and CSMA/CD is not needed.", sec: "s9" },
    { q: "What are the headline features of Fast Ethernet?",
      a: "Fast Ethernet runs at 100 Mbps, uses a hub or switch design, is compatible with standard Ethernet, and has a feature for auto-negotiation. Its 100Base-TX variant uses 4B/5B coding at a 125 Mbaud line rate.", sec: "s10" },
    { q: "What are the two modes of Gigabit Ethernet?",
      a: "Full-duplex mode uses a switch and no longer uses CSMA/CD; half-duplex mode still uses CSMA/CD and therefore has an increased minimum frame size of 512 bytes. Gigabit Ethernet also allows frame bursting.", sec: "s11" },
    { q: "Why is the half-duplex Gigabit Ethernet minimum frame 512 bytes?",
      a: "At 1000 Mbps a 64-byte frame takes only 512 ns, far less than the round-trip propagation delay, so collision detection would fail. A 512-byte minimum takes 4.096 µs, long enough for the round trip, and frame bursting avoids wasting the padding on short frames.", sec: "s11" },
    { q: "What does ARP do?",
      a: "ARP, the Address Resolution Protocol, resolves a known logical (IP) address on the same LAN into the corresponding physical (MAC) address, by broadcasting a request that only the matching host answers.", sec: "s13" },
    { q: "How does a switch populate its forwarding table?",
      a: "By transparent bridging: it learns the source MAC address of every arriving frame and records it against the arrival port, forwards on the destination address, floods unknown destinations out all other ports, and ages out stale entries.", sec: "s14" },
  ],
  quiz: [
    { q: "Project 802 was started by which body?",
      choices: ["The IEEE Computer Society", "The Internet Engineering Task Force", "The International Organization for Standardization alone", "The manufacturers of Ethernet NICs"],
      answer: 0,
      why: "The slide states plainly that Project 802 was started by the IEEE Computer Society in 1985, to standardise the physical and data-link layers of major LAN protocols.", sec: "s1" },
    { q: "Which sublayer of IEEE 802 provides a single link-layer control protocol for all IEEE LANs?",
      ...
      answer: 1,
      why: "Logical Link Control is the part of 802 that defines flow control, error control and framing and gives a single link-layer control protocol for all IEEE LANs; MAC is the technology-specific access-method sublayer.", sec: "s1" },
    { q: "Which statement best describes Ethernet's service to the layer above?",
      choices: ["Connection-oriented, reliable and acknowledged", "Connectionless and unreliable, with corrupted frames dropped silently", "Connectionless but fully reliable, with automatic retransmission", "Connection-oriented but unreliable, with no error detection"],
      answer: 1,
      why: "A frame is independent of the previous and next frame, so there is no connection setup or teardown, the sender can overwhelm the receiver, and corrupted frames are dropped silently with no link-layer retransmission.", sec: "s2" },
    { q: "In the Ethernet frame, what is the purpose of the start-of-frame delimiter?",
      choices: ["It carries the CRC-32 error-detection value", "It signals the beginning of the frame after the preamble", "It defines the upper-layer protocol being carried", "It pads short payloads up to the minimum length"],
      answer: 1,
      why: "The preamble provides synchronisation and the one-byte start-of-frame delimiter signals the beginning of the frame proper, with the pattern 10101011 breaking the alternating preamble pattern.", sec: "s3" },
    { q: "How many bytes long are the destination and source address fields of an Ethernet frame, and how long is the CRC?",
      choices: ["4, 4 and 2 bytes", "6, 6 and 4 bytes", "8, 8 and 8 bytes", "2, 2 and 4 bytes"],
      answer: 1,
      why: "Both the destination and source addresses are 48-bit fields, which is 6 bytes each, and the CRC field is a 4-byte (32-bit) error-detection value.", sec: "s3" },
    { q: "A 30-byte payload is placed into an Ethernet frame. How many bytes of padding are needed, and why?",
      choices: ["0 bytes — no padding is required", "16 bytes, to reach the 46-byte data-field minimum", "30 bytes, to reach the 60-byte data-field minimum", "4 bytes, to reach the CRC boundary"],
      answer: 1,
      why: "The data field must be at least 46 bytes so that the whole frame reaches 64 bytes, which CSMA/CD requires. 46 − 30 = 16 bytes of padding.", sec: "s4" },
    { q: "Which statement gives the correct reasons for the two Ethernet frame-length limits?",
      choices: ["The minimum prevents monopolisation; the maximum allows collision detection", "The minimum allows collision detection under CSMA/CD; the maximum prevents one station from monopolising the medium", "Both exist purely to save buffer memory", "The minimum saves memory; the maximum keeps the CRC short"],
      answer: 1,
      why: "The slides state that the minimum length restriction is required for correct CSMA/CD operation, while the maximum length prevents one station from monopolising the medium and reflects the cost of memory in the past.", sec: "s4" },
    { q: "An Ethernet destination address begins with the octet 4E. This address is:",
      choices: ["Broadcast, because all ones appear", "Multicast, because the least significant bit of the first octet is 1", "Unicast, because the least significant bit of the first octet is 0", "A source address only, never a destination"],
      answer: 2,
      why: "4E in binary is 0100 1110, whose least significant bit is 0, so the address is unicast. A multicast address would have that bit set to 1, and broadcast is the all-ones address FF:FF:FF:FF:FF:FF.", sec: "s5" },
    { q: "How many distinct 48-bit Ethernet addresses are there?",
      ...
      answer: 1,
      why: "2⁴⁸ ≈ 2.81 × 10¹⁴, which is about 281 trillion addresses. About 4.3 billion (2³²) is the size of the IPv4 space and about 65,536 is 2¹⁶.", sec: "s5" },
    { q: "Ethernet uses CSMA/CD with which persistence method and which physical-layer encoding?",
      choices: ["Non-persistent CSMA/CD with NRZ-L encoding", "1-persistent CSMA/CD with Manchester encoding", "p-persistent CSMA/CD with 4B/5B encoding", "1-persistent CSMA/CA with Manchester encoding"],
      answer: 1,
      why: "The slide states directly that Ethernet uses CSMA/CD with the 1-persistent method and uses the Manchester encoding method at the physical layer.", sec: "s6" },
    { q: "What is the maximum segment length of 10Base2?",
      choices: ["500 m", "185 m", "100 m", "2000 m"],
      answer: 1,
      why: "10Base2 is thin coaxial cable with a segment limit of 185 m. The 500 m figure belongs to 10Base5, 100 m to 10BaseT twisted pair, and 2000 m to 10BaseF fibre.", sec: "s7" },
    { q: "On a switch, how many collision domains typically exist per port?",
      choices: ["None — switches create broadcast domains instead", "One dedicated collision domain per port", "One shared collision domain for all ports", "Two, one for each duplex direction"],
      answer: 1,
      why: "Bridged Ethernet separated collision domains, and the switch went further by providing one collision domain per port, so stations on different ports never contend for a shared medium.", sec: "s8" },
    { q: "A switch receives a frame whose destination MAC address is not in its forwarding table. What does it do?",
      choices: ["Discards the frame and sends an error to the sender", "Floods the frame out every port except the one it arrived on", "Holds the frame until the destination transmits", "Forwards the frame out every port including the arrival port"],
      answer: 1,
      why: "Unknown unicast destinations are flooded out all ports except the arrival port, which is how the destination is reached and how the reply subsequently teaches the switch the missing table entry.", sec: "s14" },
    { q: "Why can a full-duplex Ethernet link ignore CSMA/CD?",
      choices: ["Because it uses a faster encoding scheme than half-duplex", "Because the transmit and receive paths are separate, so a collision is physically impossible", "Because it is always a shorter cable than a half-duplex link", "Because the frames are padded to 512 bytes"],
      answer: 1,
      why: "Full duplex requires separate paths in each direction, so a station can send and receive at the same time and two transmissions can never overlap on the medium. No collision means no need for carrier sense, collision detection or back-off.", sec: "s9" },
    { q: "What is the line rate of 100Base-TX, and where does the extra rate beyond 100 Mbps come from?",
      choices: ["100 Mbaud — there is no encoding overhead", "125 Mbaud — 4B/5B coding maps 4 data bits to 5 code bits", "200 Mbaud — Manchester encoding doubles the rate", "50 Mbaud — 5B/4B coding halves the rate"],
      answer: 1,
      why: "4B/5B replaces every four data bits with a five-bit code group, so the line rate is 100 × 5/4 = 125 Mbaud. The 25 percent overhead buys guaranteed transitions for clock recovery; 200 Mbaud would be the Manchester requirement and was rejected as too expensive.", sec: "s10" },
    { q: "What is the minimum frame size in half-duplex Gigabit Ethernet, and why?",
      choices: ["64 bytes, unchanged from standard Ethernet", "512 bytes, so the transmission time covers the collision round trip at 1000 Mbps", "1500 bytes, to match the maximum payload", "72 bytes, counting the preamble and delimiter"],
      answer: 1,
      why: "At 1000 Mbps a 64-byte frame lasts only 512 ns, far shorter than the round-trip propagation delay, so the standard raises the minimum to 512 bytes, which occupies 4.096 µs and keeps collision detection workable.", sec: "s11" },
    { q: "What problem does frame bursting solve in Gigabit Ethernet?",
      choices: ["It reduces the CRC computation time", "It lets several short frames be sent back to back so padding to 512 bytes is not wasted", "It allows half-duplex stations to transmit at full bandwidth without listening", "It removes the need for a preamble"],
      answer: 1,
      why: "Because the half-duplex minimum frame is 512 bytes, short frames would otherwise need heavy padding. Frame bursting transmits a train of short frames in one acquired transmission, keeping the medium busy for the slot time while recovering efficiency.", sec: "s11" },
    { q: "Which statement about 10 Gigabit Ethernet is correct?",
      choices: ["It uses CSMA/CD with a 512-byte minimum frame", "It is full duplex only, so CSMA/CD is not used", "It uses Manchester encoding to reach 10 Gbps", "It changes the Ethernet frame format"],
      answer: 1,
      why: "10 Gigabit Ethernet is defined for full-duplex point-to-point operation, so CSMA/CD is not used at all, and it retains the IEEE 802.3 frame format unchanged for backward compatibility.", sec: "s12" },
    { q: "Station A knows B's IP address but not its MAC address, and B is on the same LAN. What happens?",
      choices: ["A sends the data frame to the broadcast address immediately", "A sends an ARP request to the broadcast MAC address; B replies with its MAC address, which A caches", "A sends the data to the default gateway for forwarding", "A waits for B to announce itself with a gratuitous ARP"],
      answer: 1,
      why: "ARP broadcasts a request for the owner of the unicast IP address; only B answers, replying with its MAC address. A caches the IP-to-MAC mapping so later frames go straight to B.", sec: "s13" },
    { q: "Which sequence correctly describes transparent bridging on a switch?",
      choices: ["Learn from the source address, forward on the destination address, flood if unknown, filter if source and destination share a port", "Learn from the destination address, forward on the source address, flood always", "Learn from the CRC, forward on the port number, never flood", "Learn from the IP address, forward on the MAC address, drop broadcasts"],
      answer: 0,
      why: "A switch learns the arrival port of each frame's source address, forwards on the destination address, floods unknown destinations out all other ports, and filters frames whose source and destination share a port. Old entries are aged out.", sec: "s14" },
  ],
});
