  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: the two questions, and the cost of redundancy",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: the geometry of a burst",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: why bursts dominate real links",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: what redundancy buys, in information terms",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: minimum distance, detecting d errors, correcting d errors",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: worked parity encodings",
        },
        {
          type: "table",
        ...
        {
          type: "h3",
          text: "Additive depth: the limits of simple parity",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: how the correction actually happens",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: polynomial representation of bits",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: the generator polynomial and how many CRC bits it produces",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why the whole codeword divides exactly",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: how modulo-2 long division is performed",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: why polynomials are chosen for particular error behaviours",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: one's complement arithmetic",
        },
        {
          type: "p",
        ...
        {
          type: "h3",
          text: "Additive depth: worked example on the word NSCOM3",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "h3",
          text: "Additive depth: detection plus retransmission beats correction for data links",
        },
        {
          type: "p",
  ...
  flashcards: [
    {
      ...
      a: "A single-bit error changes exactly 1 bit of the data unit from 1 to 0 or 0 to 1. A burst error changes 2 or more bits in the data unit.",
      sec: "s2",
    },
    {
      q: "How is the length of a burst error measured?",
      a: "From the first corrupted bit to the last corrupted bit, inclusive. The bits inside that span that were not affected are still counted as part of the burst, so a burst of length 8 may contain as few as 2 flipped bits.",
      sec: "s2",
    },
    {
      q: "Why are burst errors more common than single-bit errors on real links?",
      a: "Interference lasts for a finite interval, and every bit on the wire during that interval can be affected. Such interference is called noise on the channel and destroys all data during that interval, so errors arrive in clusters rather than singly.",
      sec: "s2",
    },
    {
      q: "What is the central concept behind detecting or correcting errors, and who adds the extra bits?",
      a: "Redundancy. The redundant bits are added by the sender and removed by the receiver.",
      sec: "s3",
    },
    {
      q: "What information does error correction need that error detection does not?",
      a: "Error detection only asks whether any error occurred. Error correction needs the exact number of bits corrupted and, more importantly, their location in the message.",
      sec: "s3",
    },
    {
      q: "Define the Hamming distance between two words.",
      a: "The number of bit positions at which the two words differ — equivalently, the number of 1s in their XOR.",
      sec: "s4",
    },
    {
      q: "What minimum Hamming distance is needed to detect d errors, and to correct d errors?",
      a: "To detect up to d errors, d_min ≥ d + 1. To correct up to d errors, d_min ≥ 2d + 1. A code corrects up to floor(d_min / 2) errors.",
      sec: "s4",
    },
    {
      q: "State the definition of a simple parity-check code.",
      a: "A single-bit error-detecting code in which n = k + 1 with d_min = 2 — one redundant bit is appended, and the sender and receiver must agree on even or odd parity.",
      sec: "s5",
    },
    {
      q: "Which errors does simple parity fail to detect, and why?",
      a: "Errors in an even number of bits. Flipping two bits changes the count of 1s by an even amount, so the agreed parity still holds and the corrupted word is accepted silently. Parity also cannot correct anything.",
      sec: "s5",
    },
    {
      q: "How does a two-dimensional parity check correct a single-bit error?",
      a: "The data are laid out as a grid with row parities and column parities. A single flipped bit breaks exactly one row parity and one column parity; their intersection identifies the corrupted bit, which the receiver flips back.",
      sec: "s6",
    },
    {
      q: "How does CRC treat the packet of data?",
      a: "As a large polynomial. The transmitter divides the message polynomial by a given generating polynomial using polynomial arithmetic; the quotient is discarded and the remainder is attached to the end of the message.",
      sec: "s7",
    },
    {
      q: "Given a generator polynomial, how many zeros does the sender append, and how long is the CRC field?",
      a: "Append as many zeros as the degree of the generator polynomial. The CRC field has exactly that many bits, because the remainder of the division has degree less than that of the generator.",
      sec: "s7",
    },
    {
      q: "What is the receiver's CRC procedure, and what do zero and non-zero remainders mean?",
      a: "The receiver divides the message and remainder — the whole codeword — by the same generating polynomial. A remainder of zero means no error was detected (accept); a remainder not equal to zero means an error occurred during transmission (reject).",
      sec: "s8",
    },
    {
      q: "Why must leading zeros never be stripped from a CRC remainder?",
      a: "The CRC field is exactly deg(G) bits wide, and each zero is a real bit position. Dropping a zero changes which bit position is the leading one during division and makes the answer wrong. A remainder of 011 must not be written as 11.",
      sec: "s8",
    },
    {
      q: "Data 1101011011 with generator 10011. What is the CRC remainder and the transmitted codeword?",
      a: "Append four zeros (degree 4) to get 11010110110000, divide by 10011. The remainder is 1110, so the codeword is 11010110111110. Dividing that codeword by 10011 at the receiver gives remainder 0000.",
      sec: "s9",
    },
    {
      q: "Gate's slide example: P(x) = x5 + x4 + x2 + 1 and M(x) = 1010011010. What are the remainder and the codeword?",
      a: "P(x) = 110101, degree 5. Append five zeros to the message: 101001101000000. Dividing by 110101 leaves remainder 10110, so the codeword is 101001101010110. Dividing the codeword by 110101 gives remainder 00000.",
      sec: "s9",
    },
    {
      q: "List the CRC polynomials named on the slide.",
      a: "CRC-12: x12 + x11 + x3 + x2 + x + 1. CRC-16: x16 + x15 + x2 + 1. CRC-CCITT (CRC-ITU): x16 + x15 + x5 + 1. CRC-32: x32 + x26 + x23 + x22 + x16 + x12 + x11 + x10 + x8 + x7 + x5 + x4 + x2 + x + 1. ATM CRC: x8 + x2 + x + 1.",
      sec: "s10",
    },
    {
      q: "What does the degree of a CRC generator polynomial tell you about the CRC field?",
      a: "The degree r equals the number of CRC bits produced, equals the number of zeros appended before division, and equals the length of the generator's bit pattern minus one. A degree-16 generator such as CRC-16 or CRC-ITU yields a 16-bit CRC.",
      sec: "s10",
    },
    {
      q: "State the four steps of the checksum procedure.",
      a: "At the source the message is divided into m-bit units; the generator creates the checksum, an extra m-bit unit; at the destination the checker creates a new checksum from the message plus the sent checksum; if it is all 0s the message is accepted, otherwise it is discarded.",
      sec: "s11",
    },
    {
      q: "At which layers is checksum mostly used, and why does that differ from CRC?",
      a: "Checksum is mostly used at the network and transport layers rather than the data-link layer — it applies to a message of any length. CRC is a data-link technique that operates on a whole codeword.",
      sec: "s11",
    },
    {
      q: "Compute the 8-bit checksum of the ASCII bytes of NSCOM3.",
      a: "N = 0x4E, S = 0x53, C = 0x43, O = 0x4F, M = 0x4D, 3 = 0x33. One's-complement sum = 0xB4, so the checksum is the inversion of 0xB4 = 0x4B. The receiver sums all seven bytes and gets 0xFF, whose complement is 00000000 — accept.",
      sec: "s11",
    },
    {
      q: "Why is CRC preferred over checksum on Ethernet links?",
      a: "CRC gives stronger, provable guarantees on bursty media: a degree-r generator catches all single-bit errors, all burst errors of length r or less, and all odd-count errors when x + 1 divides the generator, and misses longer bursts with probability about 2^−r. Ethernet therefore uses CRC-32.",
      sec: "s12",
    },
    {
      q: "Why do data links use CRC with retransmission instead of correction?",
      a: "Correction needs far more redundancy than detection and only pays off when there is no useful return path. On a link with a return path it is cheaper to detect with a small CRC, discard the frame, and let the transport retransmit it (ARQ). Correction is reserved for deep space, broadcast and real-time streams.",
      sec: "s12",
    },
  ],
  quiz: [
    {
      ...
      answer: 0,
      why: "A single-bit error means only 1 bit of the data unit is changed from 1 to 0 or from 0 to 1. A burst error by definition involves 2 or more changed bits.",
      sec: "s2",
    },
    {
      ...
      answer: 1,
      why: "Three bits changed, which is 2 or more, so it is a burst error. The burst length is measured from the first corrupted bit to the last, giving a length of 3.",
      sec: "s2",
    },
    {
      q: "Why are burst errors the dominant error type on real transmission links?",
      choices: [
        "Because receivers sample bits too slowly",
        "Because interference lasts for a finite interval, so every bit on the wire during that interval can be affected",
        "Because CRC generators deliberately group errors",
        "Because parity can only ever create bursts",
      ],
      answer: 1,
      why: "Interference is unpredictable but finite in duration. Every bit transmitted during that interval is subject to the same disturbance, so corrupted bits arrive in clusters rather than singly.",
      sec: "s2",
    },
    {
      ...
      answer: 2,
      why: "Redundancy is the central concept. Redundant bits are added by the sender and removed by the receiver to let the receiver check the message.",
      sec: "s3",
    },
    {
      ...
      choices: [
        ...
        "The exact number of corrupted bits and their location in the message",
        "A shared secret key",
        "A higher bit rate",
      ],
      answer: 1,
      why: "In error detection we only look to see if any error has occurred. In error correction we need to know the exact number of bits corrupted and, more importantly, their location in the message.",
      sec: "s3",
    },
    {
      ...
      choices: ["2", "3", "4", "5"],
      answer: 2,
      why: "XOR the words: 10101 ⊕ 11010 = 01111, which has four 1s, so the Hamming distance is 4 — they differ in four bit positions.",
      sec: "s4",
    },
    {
      ...
      choices: ["2", "3", "5", "6"],
      answer: 2,
      why: "Correcting up to d errors requires d_min ≥ 2d + 1. With d = 2 that is d_min ≥ 2(2) + 1 = 5. Detecting 2 errors would only need d_min ≥ 3.",
      sec: "s4",
    },
    {
      ...
      answer: 1,
      why: "A simple parity-check code is a single-bit error-detecting code in which n = k + 1 with d_min = 2 — exactly one redundant bit is appended.",
      sec: "s5",
    },
    {
      ...
      answer: 1,
      why: "1100111 contains five 1s, which is odd, so the even-parity bit must be 1 to make the total six (even). The codeword is therefore 11001111.",
      sec: "s5",
    },
    {
      ...
      answer: 2,
      why: "Parity detects only odd numbers of flipped bits. Flipping two bits changes the count of 1s by an even amount, so the parity still holds and the corrupted word is accepted silently.",
      sec: "s5",
    },
    {
      q: "What unique capability does a two-dimensional parity check have among the schemes in this module?",
      choices: [
        "It detects all possible burst errors",
        "It can correct the single error bit using row and column parity",
        "It needs no redundant bits",
        "It works without the sender and receiver agreeing on anything",
      ],
      answer: 1,
      why: "Two-dimensional parity allows detection of error bits and correction of the error bit, using row parity and column parity: a single flipped bit breaks exactly one row and one column check, and their intersection locates it.",
      sec: "s6",
    },
    {
      q: "In a two-dimensional parity grid, two bits in the same row are flipped. What is the outcome?",
      choices: [
        "The error is corrected automatically",
        "The row parity fails and the column parities are fine",
        "The row parity still holds but two column parities fail, so the error is detected but not correctable",
        "Nothing is detected at all",
      ],
      answer: 2,
      why: "Two flips in one row change that row's count of 1s by an even amount, so the row parity still holds. The two affected columns both fail, so the error is detected, but the single-intersection correction rule does not apply and the block must be retransmitted.",
      sec: "s6",
    },
    {
      q: "How does CRC treat the packet of data being transmitted?",
      choices: [
        "As a sequence of independent bytes to be summed",
        "As a large polynomial that is divided by a generating polynomial",
        "As a two-dimensional grid of rows and columns",
        "As a single redundant bit appended to each unit",
      ],
      answer: 1,
      why: "The CRC method treats the packet of data as a large polynomial. The transmitter divides the message polynomial by a given generating polynomial; the quotient is discarded and the remainder is attached to the end of the message.",
      sec: "s7",
    },
    {
      ...
      answer: 1,
      why: "The degree of the generator equals the number of appended zeros before division and also equals the number of CRC bits in the codeword. A degree-4 generator produces a 4-bit remainder.",
      sec: "s7",
    },
    {
      ...
      choices: [
        "11010110110000, receiver remainder 0000",
        "11010110111110, receiver remainder 0000",
        "11010110111110, receiver remainder 1110",
        "11010110110111, receiver remainder 1110",
      ],
      answer: 1,
      why: "Four zeros are appended (degree 4), giving 11010110110000. Dividing by 10011 leaves remainder 1110, so the codeword is data plus CRC = 11010110111110. Dividing that whole codeword by 10011 gives remainder 0000, so it is accepted.",
      sec: "s9",
    },
    {
      q: "Which statement about the receiver's CRC procedure is correct?",
      choices: [
        "The receiver divides the whole codeword, message plus remainder, by the same generating polynomial",
        "The receiver strips the CRC off and divides only the data bits",
        "The receiver divides by a different polynomial chosen to match the remainder",
        "The receiver compares the CRC against a stored copy of the original message",
      ],
      answer: 0,
      why: "The receiver divides the message and remainder by the same generating polynomial. A remainder not equal to zero means there was an error during transmission; a remainder of zero means there was no error detected.",
      sec: "s8",
    },
    {
      ...
      choices: [
        "Write the three bits as they are, since leading zeros carry no value",
        "Pad it on the right with zeros to make five bits",
        "Pad it on the left with zeros to make five bits, since leading zeros are real bit positions",
        "Discard the remainder and send the quotient instead",
      ],
      answer: 2,
      why: "The CRC field is exactly deg(G) bits wide, so leading zeros are significant bit positions. A remainder of 011 is not 11; stripping a zero changes which bit position is the leading one in subsequent division steps and produces a wrong answer.",
      sec: "s8",
    },
    {
      ...
      answer: 0,
      why: "P(x) as bits is 110101, a degree-5 generator, so five zeros are appended to the message to give 101001101000000. Dividing by 110101 leaves the 5-bit remainder 10110; the codeword 101001101010110 then divides by 110101 with remainder 00000.",
      sec: "s9",
    },
    {
      ...
      answer: 1,
      why: "CRC-CCITT (CRC-ITU) is x16 + x15 + x5 + 1 — the ITU-T polynomial for 8-bit characters. The x16 + x15 + x2 + 1 form is CRC-16, the x12 form is CRC-12, and the degree-32 form is CRC-32.",
      sec: "s10",
    },
    {
      ...
      answer: 2,
      why: "The bit pattern's length is the degree plus one, because the pattern includes the constant term as well as every power of x up to the degree. So a degree-16 generator such as CRC-16 is written as a 17-bit pattern.",
      sec: "s10",
    },
    {
      ...
      answer: 1,
      why: "Checksum is an error-detecting technique applied to a message of any length and is mostly used at the network and transport layers rather than the data-link layer — the IP header checksum and TCP/UDP checksums are the standard examples.",
      sec: "s11",
    },
    {
      ...
      answer: 1,
      why: "The one's-complement sum of the six bytes is 0xB4 (the intermediate sum 0x133 wraps its carry around), so the checksum is the inversion of 0xB4 = 0x4B. The receiver adds all seven bytes to get 0xFF, whose complement is 00000000, so the message is accepted.",
      sec: "s11",
    },
    {
      q: "Why do Ethernet and most data-link technologies use CRC rather than checksum?",
      choices: [
        "Because CRC is easier for software to compute in a few instructions",
        "Because CRC applies to any message length whereas checksum does not",
        "Because checksum requires a shared secret key",
        "Because CRC gives strong burst guarantees — a degree-r generator catches all bursts of length r or less — which suits bursty media",
      ],
      answer: 3,
      why: "A degree-r generator catches all single-bit errors, all burst errors of length r or less, and all odd-count errors when x + 1 divides the generator, missing longer bursts only with probability about 2^−r. That strength matters on bursty media, where the checksum's positional weaknesses are a liability.",
      sec: "s12",
    },
    {
      ...
      answer: 0,
      why: "The CRC-32 field is 32 bits while 1,500 bytes is 12,000 bits, so the codeword is 12,032 bits and the overhead is 32 / 12,032 ≈ 0.27% — a very small price for the guarantee that catches every burst up to 32 bits.",
      sec: "s12",
    },
  ],
});
