...
window.NSCOM_MODULES.push({
  ...
  sections: [
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "The **physical layer** is the lowest layer: it moves a bit sequence across the medium to the remote node.",
            "It deals in **bits on the wire** — no frames, no addresses, no error checking.",
            "The bits are reconstructed at the far end and handed **up** to the data link layer.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "where the layer boundaries fall",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "Data are the **information**; a signal is the **energy pattern** that carries it. You cannot send one without the other.",
            "Signals are **analog** (continuous) or **digital** (discrete levels).",
            "A **periodic** signal repeats forever; a **non-periodic** one does not — and most digital signals are non-periodic.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "why data needs a signal",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "A sine wave is fully described by **three parameters: amplitude, frequency, phase**.",
            "**Amplitude** = strength (energy carried). **Frequency** = cycles per second (Hz). **Phase** = where the wave starts.",
            "Change any one of the three and you can carry information — that single fact is the basis of all modulation.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "what phase actually is",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Wavelength** is the distance one cycle occupies in the medium: **λ = propagation speed × period**.",
            "It links the signal's frequency to how fast it actually travels through that particular medium.",
            "Same signal, different medium, different wavelength — the frequency never changes, the speed does.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "wavelength vs frequency",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "A **composite signal** is many sine waves added together (Fourier's result).",
            "The lowest frequency is the **fundamental**; the others are **harmonics** — integer multiples of it.",
            "A signal's **bandwidth** is the range between its highest and lowest frequency.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "Fourier and bandwidth",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "A **digital signal** carries its data in discrete levels, not a smooth wave.",
            "If a signal has **L levels**, each level carries **log₂L bits**.",
            "**Bit rate** = bits per second. **Bit length** = how much of the medium one bit occupies.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "levels and bit length",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Baseband** = send the digital signal as-is, no carrier. Needs a dedicated wide-bandwidth medium.",
            "**Broadband** = modulate the digital signal onto a carrier first.",
            "Baseband is simpler and cheaper; broadband is what lets you share a medium or cross a bandpass channel.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "when each is used",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Attenuation** = the signal loses energy over distance. Fix it with **amplifiers**.",
            "The **decibel (dB)** measures the loss or gain: **dB = 10 log₁₀(P₂/P₁)**.",
            "Negative dB means loss, positive means gain — it's a ratio, not an absolute level.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "decibels worked out",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Distortion** = the signal changes shape, because different frequencies travel at different speeds and arrive at different times.",
            "The key contrast: **attenuation makes the signal weaker; distortion makes it wrong.** A distorted signal can still be strong.",
            "**Noise** is unwanted energy from outside — thermal, induced, crosstalk, or impulse.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "telling the three apart",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**SNR** = signal power ÷ noise power. High SNR = clean signal; low SNR = noisy signal.",
            "Because the two powers differ wildly in scale, SNR is usually quoted in **decibels: SNRdB = 10 log₁₀(SNR)**.",
            "This is the number that feeds directly into Shannon's capacity formula.",
          ],
        },
        {
          type: "deep",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Nyquist** gives the maximum bit rate of a **noiseless** channel: **N = 2 × B × log₂L**.",
            "B is bandwidth in Hz, L is the number of signal levels.",
            "More bandwidth or more levels = faster — but adding levels only works while the channel stays quiet.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "the full derivation",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Shannon** gives the maximum capacity of a **noisy** channel: **C = B × log₂(1 + SNR)**.",
            "Note what's missing: the **signal levels don't appear**. Once noise is present, more levels buy you nothing.",
            "This is the hard ceiling — you cannot beat Shannon, only approach it with better coding.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "why levels vanish",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "**Throughput** = how fast data actually gets through, which is usually **less** than bandwidth.",
            "**Latency** = total delay = propagation + transmission + queuing.",
            "**Propagation time** = distance ÷ propagation speed. **Jitter** = variation in delay, which wrecks real-time audio and video.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "the four delay terms",
          body: [
            {
              type: "p",
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "The module is one chain: data → signal → time and frequency views → sine wave parameters → composite signals → impairments → rate limits.",
            "**Nyquist** bounds a clean channel; **Shannon** bounds a noisy one. Together they set every speed limit in the subject.",
            "In practice we use **periodic analog signals** to carry **non-periodic digital data**.",
          ],
        },
        {
          type: "deep",
          label: "Go deeper",
          hint: "how it all connects",
          body: [
            {
              type: "list",
              items: [
  ...
  flashcards: [
    { q: "Which layer of the OSI model transmits bits over the medium?",
      a: "The physical layer — the lowest layer. It transmits bit sequences through the medium to the physical layer of the remote node, where frames are reconstructed and passed up to the data link layer.", sec: "s1" },
    { q: "Name the four kinds of physical-layer specification details.",
      a: "Mechanical (cable and connector types), electrical (voltage levels, data rate, distance), functional (what each pin or circuit does) and procedural (the sequence of events for a transfer).", sec: "s1" },
    { q: "What is the difference between an analog and a digital signal?",
      a: "An analog signal has infinitely many levels of intensity over a period of time. A digital signal can have only a limited number of defined values — it jumps between discrete levels.", sec: "s2" },
    { q: "Define a periodic signal and its period.",
      a: "A periodic signal has a repeating pattern within a time frame; that time frame is the period. It repeats identically over subsequent periods, and completing one full pattern is one cycle.", sec: "s2" },
    { q: "What three parameters describe a sine wave?",
      a: "Amplitude, frequency and phase. Amplitude is the absolute value of the highest intensity; frequency is the number of periods in one second; phase describes the waveform's position relative to time zero.", sec: "s3" },
    { q: "Give the relations between period and frequency.",
      a: "T = 1/f, f = 1/T, and the time to complete one cycle = 1/f. If 4 cycles fit in 1 second, f = 4 Hz and T = 0.25 s.", sec: "s3" },
    { q: "What units is phase measured in?",
      a: "Degrees or radians. A quarter-cycle shift is 90°, a half-cycle shift is 180°, and a full cycle is 360° (2π radians).", sec: "s3" },
    { q: "State the wavelength formula and what it links.",
      a: "λ = c/f = c·T. Wavelength binds the period or frequency of a simple sine wave to the propagation speed of the medium, and is measured in metres.", sec: "s4" },
    { q: "What is the wavelength of red light at 4 × 10¹⁴ Hz in free space?",
      a: "λ = (3 × 10⁸) / (4 × 10¹⁴) = 0.75 × 10⁻⁶ m = 0.75 µm.", sec: "s4" },
    { q: "What did Fourier show about composite signals?",
      a: "That a composite signal is a combination of simple sine waves with different frequencies, amplitudes and phases. Composite signals may be periodic or non-periodic.", sec: "s5" },
    { q: "How is the bandwidth of a composite signal defined?",
      a: "As the range of frequencies contained in the signal — normally expressed as the difference between the highest and lowest frequency: B = f_high − f_low.", sec: "s5" },
    { q: "If a signal has L levels, how many bits does each level carry?",
      a: "log2 L bits per level. Two levels carry 1 bit, four levels carry 2 bits, eight levels carry 3 bits, sixteen levels carry 4 bits.", sec: "s6" },
    { q: "Distinguish bit rate from bit interval.",
      a: "Bit rate is the number of bits sent in one second (bps). Bit interval is the time one bit occupies (1 / bit rate), or spatially the distance one bit occupies on the medium. At 1 Mbps the bit interval is 1 µs.", sec: "s6" },
    { q: "What is baseband transmission?",
      a: "Sending a digital signal over a channel without changing it into an analog signal. It needs a low-pass, wide-bandwidth dedicated medium — the digital signal is placed on the medium as-is.", sec: "s7" },
    { q: "What does modulation let a broadband system do?",
      a: "It changes the digital signal into an analog signal so a bandpass channel can be used — a channel whose bandwidth does not start from zero, such as radio, DSL or cable-data spectrum.", sec: "s7" },
    { q: "Three impairments a signal suffers in a medium?",
      a: "Attenuation (loss of energy), distortion (change of form or shape) and noise (unwanted energy added by the channel). Noise types include thermal, induced, crosstalk and impulse.", sec: "s8" },
    { q: "Give the decibel formula and sign convention.",
      a: "dB = 10 log10(P2/P1). It is negative if the signal is attenuated and positive if the signal is amplified. Halving the power is about −3 dB; doubling is about +3 dB.", sec: "s8" },
    { q: "A signal's power is reduced to one-half. What is the attenuation in dB?",
      a: "dB = 10 log10(1/2) = 10 × (−0.301) = −3.01 dB, conventionally quoted as −3 dB.", sec: "s8" },
    { q: "What causes distortion and why does it matter?",
      a: "Distortion means the signal changes its form or shape. It occurs in composite signals when components of different frequencies arrive at different times because of different propagation speeds per frequency — the waveform is deformed even though power may be unchanged.", sec: "s9" },
    { q: "Name the four types of noise and their sources.",
      a: "Thermal — random motion of electrons in a wire. Induced — motors and appliances acting as a sending antenna while the medium acts as a receiving antenna. Crosstalk — signals jumping between adjacent wires. Impulse — spikes from power lines, lightning and the like.", sec: "s9" },
    { q: "Define SNR and SNRdB.",
      a: "SNR is the ratio of what is wanted (signal power) to what is not wanted (noise power): SNR = P_signal / P_noise. SNRdB = 10 log10(SNR). A high SNR means the signal is less corrupted by noise.", sec: "s10" },
    { q: "Signal power 10 mW, noise power 1 µW. Find SNR and SNRdB.",
      a: "SNR = 10⁻² / 10⁻⁶ = 10,000. SNRdB = 10 log10(10,000) = 40 dB.", sec: "s10" },
    { q: "On what three factors does data rate depend?",
      a: "The bandwidth available, the level of the signals we use, and the quality of the channel (the level of noise).", sec: "s11" },
    { q: "State the Nyquist bit rate formula and its condition.",
      a: "BitRate = 2 × B × log2 L, where B is the channel bandwidth in hertz and L the number of signal levels. It applies to a noiseless channel and assumes no noise at all.", sec: "s11" },
    { q: "A 3000 Hz noiseless channel uses two levels. What is the data rate?",
      a: "BitRate = 2 × 3000 × log2 2 = 2 × 3000 × 1 = 6000 bps = 6 kbps.", sec: "s11" },
    { q: "State Shannon's capacity formula and what it depends on.",
      a: "C = B × log2(1 + SNR), where B is bandwidth in hertz and SNR is the plain power ratio. It depends only on bandwidth and SNR — signal levels do not appear, so levels do not dictate the capacity.", sec: "s12" },
    { q: "Find the Shannon capacity of a 3000 Hz telephone line with SNR 3162.",
      a: "C = 3000 × log2(3163) ≈ 3000 × 11.627 ≈ 34,881 bps ≈ 34.9 kbps. That SNR corresponds to about 35 dB.", sec: "s12" },
    { q: "Channel bandwidth 1 MHz, SNR 63. What is the capacity and the level count for 4 Mbps?",
      a: "Capacity = 1 × 10⁶ × log2(64) = 6 Mbps, the upper limit. Using 4 Mbps for better performance, Nyquist gives 4 × 10⁶ = 2 × 10⁶ × log2 L, so log2 L = 2 and L = 4 levels.", sec: "s12" },
    { q: "Distinguish bandwidth from throughput.",
      a: "Bandwidth is the theoretical capacity of a link, in hertz or bits per second. Throughput is how fast data can actually be sent through the network. A link of bandwidth B delivers throughput T with T always less than B.", sec: "s13" },
    { q: "What four terms make up latency?",
      a: "Propagation time + transmission time + queuing time + processing delay. Latency is how long it takes for an entire message to arrive at the destination from the moment the first bit is sent.", sec: "s13" },
    { q: "Give the formulas for propagation time and transmission time.",
      a: "Propagation time = Distance / Propagation Speed. Transmission time = Message size / Bandwidth.", sec: "s13" },
    { q: "2.5-KB message over 1 Gbps across 12,000 km at 2.4 × 10⁸ m/s. Find both times.",
      a: "Propagation = (12,000 × 1000)/(2.4 × 10⁸) = 0.05 s = 50 ms. Transmission = (2500 × 8)/10⁹ = 0.00002 s = 0.020 ms.", sec: "s13" },
    { q: "What is jitter?",
      a: "The difference in delay or latency per packet — the variation in arrival time from packet to packet. Streaming media is sensitive to jitter and buffers packets to smooth it out.", sec: "s13" },
    { q: "Why does the slides' summary say a digital signal has infinite bandwidth?",
      a: "Because a digital (square-ish) signal is a composite analog signal built from infinitely many harmonics. Perfect sharp edges would require every frequency, so the theoretical bandwidth is infinite.", sec: "s14" },
    { q: "Which formula applies to a noiseless channel and which to a noisy one?",
      a: "Nyquist's bit rate formula (BitRate = 2 B log2 L) applies to a noiseless channel; Shannon's capacity (C = B log2(1 + SNR)) applies to a noisy channel and is the one to use when noise is a factor.", sec: "s14" },
  ],
  quiz: [
    { q: "Which statement best describes the physical layer's job in the OSI model?",
      choices: ["It regulates the format and sequencing of frames between adjacent nodes", "It transmits bit sequences through the network medium to the physical layer of the remote node", "It provides end-to-end reliable delivery and flow control between processes", "It selects routes across the internetwork using addressing information"],
      answer: 1,
      why: "The physical layer is the lowest OSI layer and is responsible for transmitting bit sequences through the network medium to the physical layer of the remote node, where frames are reconstructed and passed to the data link layer.", sec: "s1" },
    { q: "Which set of details belongs to a physical-layer specification?",
      choices: ["Frame boundaries, sequence numbers and acknowledgements", "Port numbers, session state and encryption keys", "Cable and connector types, the electrical signals on each pin, and how bit values become physical signals", "Subnet masks, routing tables and logical addresses"],
      answer: 2,
      why: "The slides state that physical layer specifications include the type of cable and connectors used, the electrical signals associated with each pin and connector, and the manner in which bit values are converted into physical signals — for both wired and wireless environments.", sec: "s1" },
    { q: "An analog signal is best described as one that:",
      choices: ["has exactly two defined values that switch instantly", "has infinitely many levels of intensity over a period of time", "repeats every fixed number of nanoseconds", "always carries exactly one bit at a time"],
      answer: 1,
      why: "The slide definition is that an analog signal has infinitely many levels of intensity over a period of time, whereas a digital signal can have only a limited number of defined values.", sec: "s2" },
    { q: "A signal repeats its pattern every 0.2 s. What is its frequency?",
      choices: ["0.2 Hz", "2 Hz", "5 Hz", "20 Hz"],
      answer: 2,
      why: "Frequency is the reciprocal of the period: f = 1/T = 1/0.2 = 5 Hz. Period and frequency are inverses, so a short period means a high frequency.", sec: "s3" },
    { q: "A sine wave is described by which three parameters?",
      choices: ["Amplitude, frequency and phase", "Bit rate, bandwidth and throughput", "Voltage, current and resistance", "Period, wavelength and jitter"],
      answer: 0,
      why: "The slides state that a sine wave can be represented by three parameters: frequency, amplitude and phase. Wavelength and period are derived from these rather than being independent descriptors.", sec: "s3" },
    { q: "Phase is measured in:",
      choices: ["hertz", "degrees or radians", "seconds", "metres"],
      answer: 1,
      why: "Phase, or phase shift, describes the position of the waveform relative to time zero and is measured in degrees or radians — a quarter cycle is 90°, a half cycle 180°, a full cycle 360°.", sec: "s3" },
    { q: "Red light has a frequency of 4 × 10¹⁴ Hz and propagates in free space at 3 × 10⁸ m/s. What is its wavelength?",
      ...
      answer: 0,
      why: "λ = c/f = (3 × 10⁸)/(4 × 10¹⁴) = 0.75 × 10⁻⁶ m = 0.75 µm. The 0.75 nm option confuses the exponent; 7.5 mm confuses the magnitude of the division.", sec: "s4" },
    { q: "A composite signal contains frequencies from 300 Hz to 3300 Hz. What is its bandwidth?",
      ...
      answer: 2,
      why: "Bandwidth is the difference between the two numbers: 3300 − 300 = 3000 Hz. The highest frequency alone (3300 Hz) is not the bandwidth, and the sum of the two is meaningless here.", sec: "s5" },
    { q: "A digital signal uses 8 signal levels. How many bits does each level carry?",
      choices: ["2 bits", "3 bits", "4 bits", "8 bits"],
      answer: 1,
      why: "If a signal has L levels, each level needs log2 L bits. log2 8 = 3, so eight levels carry three bits per symbol.", sec: "s6" },
    { q: "A link runs at 500 kbps. What is the bit interval?",
      choices: ["2 µs", "0.5 µs", "2 ms", "500 µs"],
      answer: 0,
      why: "Bit interval = 1 / bit rate = 1 / 500,000 s = 2 × 10⁻⁶ s = 2 µs. Dividing instead of taking the reciprocal, or sliding a factor of 1000, produces the other options.", sec: "s6" },
    { q: "What is the essential difference between baseband and broadband transmission?",
      choices: ["Baseband uses fibre while broadband uses copper", "Baseband sends the digital signal as-is over a low-pass channel; broadband modulates it to analog for a bandpass channel", "Baseband is analogue while broadband is digital", "Baseband is always wireless while broadband is always wired"],
      answer: 1,
      why: "Baseband transmission sends a digital signal over a channel without changing it to an analog signal, needing a wide-bandwidth low-pass medium. Broadband transmission changes the digital signal to analog so modulation can use a bandpass channel that does not start at zero.", sec: "s7" },
    { q: "A signal's power drops to one quarter of its original value. What is the change in decibels?",
      ...
      answer: 1,
      why: "dB = 10 log10(1/4) = 10 × (−0.602) = −6.02 dB ≈ −6 dB. Halving the power is −3 dB, so halving twice gives −6 dB; the minus sign indicates attenuation.", sec: "s8" },
    { q: "Which noise type comes from motors and appliances acting as a sending antenna while the medium acts as a receiving antenna?",
      ...
      answer: 1,
      why: "The slide defines induced noise as coming from sources such as motors and appliances which act as a sending antenna while the medium acts as a receiving antenna. Crosstalk is coupling between adjacent wires, and impulse noise is a spike from power lines or lightning.", sec: "s9" },
    { q: "Which noise type is described as a spike coming from power lines and lightning?",
      choices: ["Thermal noise", "Induced noise", "Crosstalk", "Impulse noise"],
      answer: 3,
      why: "Impulse noise is defined on the slide as a spike that comes from power lines, lightning and the like. It is short in duration but high in amplitude, which is why it can corrupt a burst of adjacent bits.", sec: "s9" },
    { q: "The power of a signal is 10 mW and the noise power is 1 µW. What are SNR and SNRdB?",
      ...
      answer: 1,
      why: "10 mW = 10⁻² W and 1 µW = 10⁻⁶ W, so SNR = 10⁻²/10⁻⁶ = 10,000. Then SNRdB = 10 log10(10,000) = 40 dB. The 4 dB option forgets to multiply the logarithm by ten.", sec: "s10" },
    { q: "A noiseless channel has a bandwidth of 3000 Hz and uses two signal levels. What is the theoretical data rate?",
      ...
      answer: 2,
      why: "Nyquist gives BitRate = 2 × B × log2 L = 2 × 3000 × log2 2 = 2 × 3000 × 1 = 6000 bps. Dropping the factor of 2 gives 3000 bps; using four levels would give 12000 bps.", sec: "s11" },
    { q: "A 4000 Hz noiseless channel uses 8 signal levels. What is the maximum bit rate?",
      choices: ["12 kbps", "24 kbps", "32 kbps", "48 kbps"],
      answer: 1,
      why: "BitRate = 2 × 4000 × log2 8 = 2 × 4000 × 3 = 24,000 bps = 24 kbps. Using log2 8 = 4 by mistake yields 32 kbps, a common slip.", sec: "s11" },
    { q: "Which quantity is deliberately absent from Shannon's capacity formula?",
      choices: ["The bandwidth of the channel", "The signal-to-noise ratio", "The number of signal levels", "The channel capacity in bits per second"],
      answer: 2,
      why: "The slide notes there is no indication of the signal level in Shannon's formula, meaning the levels of the signal do not dictate the capacity of the channel. Capacity depends only on bandwidth and SNR.", sec: "s12" },
    { q: "A 3000 Hz telephone line has an SNR of 3162. What is the theoretical capacity?",
      ...
      answer: 2,
      why: "C = B log2(1 + SNR) = 3000 × log2(3163) ≈ 3000 × 11.627 ≈ 34,881 bps, about 34.9 kbps. Multiplying by the plain SNR instead of its logarithm gives wild overestimates.", sec: "s12" },
    { q: "A channel has 1 MHz bandwidth and SNR 63. If the design rate is 4 Mbps, how many signal levels does Nyquist require?",
      ...
      answer: 1,
      why: "Nyquist: 4 × 10⁶ = 2 × 10⁶ × log2 L, so log2 L = 2 and L = 2² = 4 levels. The channel's Shannon ceiling is 6 Mbps; the design deliberately uses 4 Mbps for better performance.", sec: "s12" },
    { q: "A link has a bandwidth of 100 Mbps but only 40 Mbps of data actually gets through. What is the 40 Mbps called?",
      ...
      answer: 1,
      why: "Throughput is a measure of how fast we can actually send data through a network. A link may have bandwidth B but can only send throughput T, with T always less than B because of overhead, contention and other factors.", sec: "s13" },
    { q: "Which of the following is NOT one of the four terms that make up latency?",
      ...
      answer: 3,
      why: "Latency = propagation time + transmission time + queuing time + processing delay. Wavelength is a spatial property of a signal in a medium, not a component of delay.", sec: "s13" },
    { q: "A 2.5-KB message crosses 12,000 km on a 1 Gbps link at a propagation speed of 2.4 × 10⁸ m/s. What are the propagation and transmission times?",
      choices: ["50 ms and 0.020 ms", "0.020 ms and 50 ms", "20 ms and 0.05 ms", "5 ms and 0.2 ms"],
      answer: 0,
      why: "Propagation time = (12,000 × 1000)/(2.4 × 10⁸) = 0.05 s = 50 ms. Transmission time = (2500 × 8)/10⁹ = 0.00002 s = 0.020 ms. Distance, not bandwidth, dominates this link.", sec: "s13" },
    { q: "Which statement about the module's summary is correct?",
      choices: ["A digital signal is a composite analog signal with a finite bandwidth equal to its bit rate", "A digital signal is a composite analog signal with an infinite bandwidth", "Digital signals are always periodic and analog signals always aperiodic", "Attenuation and noise improve the signal-to-noise ratio"],
      answer: 1,
      why: "The summary states that a digital signal is a composite analog signal with an infinite bandwidth, because perfect edges require infinitely many harmonics. The other options contradict the slide's summary points.", sec: "s14" },
  ],
});
